...
description: "Crée des campagnes de génération de demande, optimise les dépenses publicitaires sur LinkedIn, Google et Meta, développe des stratégies SEO et structure des programmes de partenariat. À utiliser pour planifier une stratégie de génération de demande, le marketing de croissance, les campagnes publicitaires, l'optimisation PPC, la génération de leads, la génération de pipeline ou les budgets marketing. Couvre l'acquisition multicanal (Google Ads, LinkedIn Ads, Meta Ads), l'analyse CAC, les flux de travail MQL/SQL, la modélisation d'attribution, le SEO technique et les partenariats co-marketing. Le profil de calibrage par défaut est un SaaS B2B Series A+ en croissance internationale (EU/US/Canada, hybride PLG/Sales-Led) — adapter les benchmarks pour d'autres stades et approches plutôt que de passer ce skill."
triggers:
  - demand gen
  - demand generation
  - paid ads

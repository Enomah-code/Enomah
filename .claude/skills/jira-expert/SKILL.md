---
name: "jira-expert"
description: "Expert Atlassian Jira pour la création et la gestion de projets, la planification, la découverte produit, les requêtes JQL, les workflows, les champs personnalisés, l'automatisation, le reporting et toutes les fonctionnalités Jira. À utiliser lors de la mise en place ou de la configuration de projets Jira, de la rédaction de requêtes JQL et de recherches avancées, de la création de tableaux de bord, de la conception de workflows, ou de toute opération technique sur Jira."
---

---
name: "marketing-ops"
description: "Routeur central pour l'écosystème de skills marketing. À utiliser quand on n'est pas sûr du skill marketing à utiliser, lors de l'orchestration d'une campagne multi-skills, ou lors de la coordination entre contenu, SEO, CRO, canaux et analytics. À utiliser aussi quand l'utilisateur mentionne 'aide marketing', 'plan de campagne', 'que faire ensuite', 'priorités marketing', ou 'coordonner le marketing'."
license: MIT
metadata:
  version: 1.0.0

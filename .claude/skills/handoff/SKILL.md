---
name: handoff
description: "Condense la conversation en cours en un document de passation pour qu'un autre agent puisse la reprendre. Référence les artefacts existants (PRDs, plans, ADRs, issues, commits, diffs) par chemin ou URL plutôt que de les dupliquer. Utiliser lorsque l'utilisateur souhaite transmettre la conversation à un nouvel agent ou démarre une nouvelle session qui reprend un travail antérieur."

---
name: wiki-query
description: "Interroge le Wiki LLM — lit d'abord index.md, explore 3 à 10 pages pertinentes, synthétise une réponse avec des citations [[wikilink]] intégrées, et propose d'archiver la réponse en tant que nouvelle page de comparaison ou de synthèse. Usage : /wiki-query \"<question>\""
---

...
description: "Architecture mémoire à deux couches pour les décisions de réunion de conseil d'administration. Gère les transcriptions brutes (Couche 1) et les décisions approuvées (Couche 2). À utiliser pour consigner des décisions après une réunion de conseil, consulter les décisions passées avec /cs:decisions, ou vérifier les actions en retard avec /cs:review. Invoqué automatiquement par le skill board-meeting après l'approbation du fondateur en Phase 5."
license: MIT
metadata:
  version: 1.0.0

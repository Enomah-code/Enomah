...
description: "À utiliser lors de la construction d'une prévision trimestrielle de réservations, d'une projection ARR, d'une prévision de pipeline, d'une projection NRR, ou d'un chiffre de conseil commit/meilleur cas/pipeline seul — particulièrement lorsque le CRO doit présenter au conseil le calcul de l'entonnoir + l'ARR par cohorte + les hypothèses de conversion par étape sans le théâtre d'un chiffre unique non défendu. Décompose le pipeline en niveaux commit, meilleur cas et pipeline seul ; projette le NRR/GRR au niveau des cohortes pour faire remonter les cohortes déficitaires avant qu'elles n'apparaissent dans le chiffre consolidé ; évalue la confiance de l'entonnoir par étape afin que les étapes à plancher mou soient traitées différemment des étapes à haute confiance. Chaque sortie nomme explicitement le taux de conversion utilisé, la fenêtre de données et le choix de pondération. Pour le Head of Commercial, RevOps, VP Sales et CRO lors de la prévision trimestrielle ou de la préparation du conseil. PAS pour la clôture financière (voir finance/financial-analysis). PAS pour le recrutement/territoire CRO stratégique (voir c-level-advisor/cro-advisor). PAS pour la tarification (voir pricing-strategist)."
version: 2.8.0

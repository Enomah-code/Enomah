---
name: "product-skills"
description: "Routeur/index pour les 12 skills produit inclus dans ce plugin (priorisation RICE, OKR, recherche UX, design tokens, analyse concurrentielle, analytics, expérimentations, discovery, roadmaps, spec-to-repo, pages d'atterrissage, scaffolding SaaS). À utiliser quand une demande produit ne correspond pas évidence à un seul skill et que vous devez choisir le bon (ex. : « aide-moi à prioriser des fonctionnalités », « planifie une expérience produit »)."
version: 2.9.0

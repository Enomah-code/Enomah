---
name: "capa-officer"
description: "Gestion du système CAPA pour le QMS des dispositifs médicaux. Couvre l'analyse des causes racines, la planification des actions correctives, la vérification de l'efficacité et les métriques CAPA. À utiliser pour mener des investigations CAPA, des analyses 5 Pourquoi, des diagrammes en arête de poisson, la détermination des causes racines, le suivi des actions correctives, la vérification de l'efficacité ou l'optimisation du programme CAPA."
triggers:
  - CAPA investigation
  - root cause analysis
  - 5 Why analysis

...
description: "Réduire le churn volontaire et involontaire via la conception des tunnels d'annulation, les offres de rétention, les enquêtes de sortie et les séquences de relance pour impayés. À utiliser pour concevoir ou optimiser un tunnel d'annulation, construire des offres de rétention, mettre en place des emails de relance pour impayés, ou réduire le churn lié aux paiements échoués. Mots-clés déclencheurs : tunnel d'annulation, réduction du churn, offres de rétention, relance impayés, enquête de sortie, récupération de paiement, réactivation, churn involontaire, paiements échoués, page d'annulation. PAS pour le scoring de santé client ou les revenus d'expansion — utiliser customer-success-manager pour cela."
license: MIT
metadata:
  version: 1.0.0

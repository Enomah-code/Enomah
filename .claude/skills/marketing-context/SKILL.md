...
description: "Crée et maintient le document de contexte marketing que tous les skills marketing lisent avant de commencer. À utiliser quand l'utilisateur mentionne 'contexte marketing', 'voix de marque', 'configurer le contexte', 'audience cible', 'ICP', 'guide de style', 'qui est mon client', 'positionnement', ou veut éviter de répéter des informations fondamentales entre les tâches marketing. À exécuter en début de tout nouveau projet avant d'utiliser d'autres skills marketing."
license: MIT
metadata:
  version: 1.0.0

---
name: "scrum-master"
description: "Compétence avancée de Scrum Master pour l'analyse et le coaching d'équipes agiles orientées données. À utiliser quand l'utilisateur pose des questions sur la planification de sprint, le suivi de vélocité, les rétrospectives, la facilitation des stand-ups, le grooming du backlog, les story points, les burndown charts, la résolution de blocages ou la santé de l'équipe agile. Exécute des scripts Python pour analyser les exports JSON de sprint depuis Jira ou outils similaires : velocity_analyzer.py pour les prévisions de sprint Monte Carlo, sprint_health_scorer.py pour le scoring de santé multi-dimensions, et retrospective_analyzer.py pour le suivi des actions et des thèmes. Produit des prévisions par intervalles de confiance, des rapports de note de santé et des tendances de vélocité d'amélioration pour les équipes Scrum hautement performantes."
license: MIT
metadata:
  version: 2.0.0

...
description: "Concevoir, optimiser et communiquer la tarification SaaS — structure des niveaux, métriques de valeur, pages de tarification et stratégie de hausse des prix. À utiliser lors de la construction d'un modèle de tarification de zéro, de la refonte d'une tarification existante, de la planification d'une hausse de prix ou de l'amélioration d'une page de tarification. Mots-clés déclencheurs : niveaux de tarification, page de tarification, hausse de prix, packaging, métrique de valeur, tarification par siège, tarification à l'usage, freemium, bon-meilleur-optimal, stratégie de tarification, monétisation, conversion de page de tarification, Van Westendorp. PAS pour la stratégie produit globale — utiliser product-strategist pour cela. PAS pour le succès client ou les renouvellements — utiliser customer-success-manager pour les revenus d'expansion."
license: MIT
metadata:
  version: 1.0.0

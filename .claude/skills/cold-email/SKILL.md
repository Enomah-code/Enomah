---
name: "cold-email"
description: "Lorsque l'utilisateur souhaite écrire, améliorer ou construire une séquence d'emails de démarchage B2B à froid vers des prospects qui n'ont pas demandé à être contactés. À utiliser lorsque l'utilisateur mentionne « cold email », « cold outreach », « emails de prospection », « emails SDR », « emails de vente », « premier contact », « séquence de suivi » ou « prospection par email ». À utiliser aussi lorsqu'il partage un brouillon d'email au ton trop commercial à humaniser. Distinct de email-sequence (cycle de vie/nurturing vers des abonnés opt-in) — ceci est une prospection non sollicitée vers de nouveaux prospects. PAS pour les emails de cycle de vie, newsletters ou campagnes drip (utiliser email-sequence)."
license: MIT
metadata:
  version: 1.0.0

---
description: "Revue d'ingénierie frontend — parcourt les 7 questions de cadrage de Matt Pocock (appareil, cible LCP, rendu, budget de bundle, SEO vs auth, système de design, WCAG), sélectionne le framework et le profil de rendu, délègue aux spécialistes (a11y-audit, performance-profiler, epic-design). Invoque l'agent cs-frontend-engineer avec un fork de contexte."

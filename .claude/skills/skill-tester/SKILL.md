---
name: "skill-tester"
description: "Valide, teste et évalue la qualité des skills au sein de l'écosystème claude-skills. Méta-skill complet : validation de structure, test de scripts Python (syntaxe + imports + exécution + format de sortie), scoring qualité multidimensionnel avec notes alphabétiques et classification par palier (BASIC/STANDARD/POWERFUL). À utiliser lors de la création d'un nouveau skill, de l'audit de skills existants pour une promotion de palier, de la configuration de hooks pre-commit pour la qualité des skills, ou de l'intégration du contrôle qualité des skills dans un CI."
---

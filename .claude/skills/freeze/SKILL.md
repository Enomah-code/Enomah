---
name: "freeze"
description: "/cs:freeze <décision> <jours> — Verrouille une décision stratégique pendant une période de refroidissement pour éviter les revirements impulsifs. Reproduit les primitives de sécurité de gstack pour la couche métier. À utiliser quand une décision irréversible a été prise sous pression — par exemple un plan de licenciement ou un contrat pluriannuel — et mérite un délai de réflexion avant exécution."
---

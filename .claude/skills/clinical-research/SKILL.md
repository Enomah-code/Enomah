...
description: "À utiliser pour concevoir une étude clinique prospective avant soumission — sélection et classification des critères d'évaluation (principal / clé secondaire / exploratoire, avec signalement des critères de substitution), estimation de la taille d'échantillon et de la puissance pour des plans à deux bras (moyennes / proportions / survie), ou notation d'un plan d'étude pour la faisabilité et une décision de passage de phase GO / GO-SOUS-CONDITIONS / RECONCEVOIR / NO-GO. Chaque résultat est une ESTIMATION accompagnée d'un responsable humain nommé (clinicien / biostatisticien / responsable réglementaire) — jamais un fait clinique, jamais un protocole finalisé. Distinct de ra-qm-team, qui gère la soumission réglementaire/QM (ISO 13485, EU MDR, FDA 510(k)/PMA/QSR), pas la conception de l'étude."
version: 2.9.0

---
name: wiki-lint
description: "Effectue un contrôle de santé du vault Wiki LLM — vérifications mécaniques (orphelins, liens brisés, pages obsolètes, métadonnées manquantes, écart de journal, doublons) ainsi que vérifications sémantiques (contradictions, lacunes de références croisées, concepts sans leur propre page). Produit un rapport Markdown avec des actions suggérées. Usage : /wiki-lint [--stale-days N] [--log-gap-days N]"
---

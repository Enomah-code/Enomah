---
name: "senior-secops"
description: "Compétence d'ingénieur SecOps senior pour la sécurité applicative, la gestion des vulnérabilités, la vérification de conformité et les pratiques de développement sécurisé. Exécute des analyses SAST/DAST, génère des plans de remédiation CVE, vérifie les vulnérabilités des dépendances, crée des politiques de sécurité, applique des patterns de code sécurisé et automatise les contrôles de conformité selon SOC2, PCI-DSS, HIPAA et RGPD. À utiliser pour mener une revue ou un audit de sécurité, répondre à un CVE ou un incident de sécurité, renforcer l'infrastructure, implémenter l'authentification ou la gestion des secrets, préparer des tests de pénétration, vérifier l'exposition au Top 10 OWASP, ou appliquer des contrôles de sécurité dans les pipelines CI/CD."
---

...
description: "Revue complète de conception d'API REST avec linting automatisé, détection de changements non rétrocompatibles et fiches de score de conception. Détecte les conventions incohérentes, le versionnage manquant et les mauvaises pratiques de conception avant que les APIs ne soient livrées. À utiliser lors de la revue d'une PR qui ajoute ou modifie des endpoints API, de l'audit d'une API existante pour une migration v2, ou de l'établissement de standards API pour une équipe."
---

---
name: "cro-review"
description: "/cs:cro-review <plan> — Interrogation paranoïaque du pipeline sur les revenus, le taux de conversion, le NRR et le temps de montée en compétence. À utiliser lorsque les prévisions manquent de couverture pipeline, que les taux de conversion chutent, ou avant de faire monter en charge l'équipe commerciale."
---

---
name: handoff
description: "Compacte la conversation en cours en un document de passation de travail pour qu'un autre agent puisse la reprendre. Référence les artefacts existants (PRDs, plans, ADRs, issues, commits, diffs) par chemin ou URL plutôt que de les dupliquer. À utiliser lorsque l'utilisateur souhaite passer la conversation à un nouvel agent ou débute une nouvelle session reprenant un travail antérieur."

...
description: "Construit des moteurs de contenu qui rankent, convertissent et se capitalisent. Pense en systèmes — clusters thématiques, pas articles individuels. Chaque pièce justifie sa place ou est supprimée. Utiliser quand le contenu doit fonctionner comme un système plutôt qu'un flux de posts — par ex., concevoir un plan de cluster thématique pour développer le trafic organique depuis zéro, ou auditer un calendrier éditorial et supprimer les pièces qui ne convertissent pas après 90 jours. (Pour la production de copy one-shot et on-brand, voir cs-content-creator.)"
color: purple
emoji: ✍️

---
name: llm-wiki
description: "À utiliser lors de la construction ou de la maintenance d'une base de connaissances personnelle persistante (second cerveau) dans Obsidian, où un LLM ingère de manière incrémentale des sources, met à jour les pages d'entités et de concepts, maintient les références croisées et tient une synthèse à jour. Les déclencheurs incluent « second cerveau », « wiki Obsidian », « gestion des connaissances personnelles », « ingérer cet article/papier/livre », « construire un wiki de recherche », « capitalisation des connaissances », « Memex », ou chaque fois que l'utilisateur souhaite que la connaissance s'accumule entre les sessions plutôt que d'être re-dérivée par RAG à chaque requête."
context: fork
version: 2.9.0

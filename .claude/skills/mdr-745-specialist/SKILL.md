...
description: "Spécialiste conformité MDR UE 2017/745 pour la classification des dispositifs médicaux, la documentation technique, les preuves cliniques et la surveillance après commercialisation. Couvre les règles de classification de l'Annexe VIII, les dossiers techniques Annexe II/III, l'évaluation clinique Annexe XIV, les calendriers PSUR de l'Art. 86, et l'intégration EUDAMED. À utiliser pour classer un dispositif médical sous MDR, construire ou auditer un dossier technique, planifier une évaluation clinique ou une cadence PMS/PSUR, ou préparer une revue par un organisme notifié (ex. : 'quelle classe est mon dispositif sous MDR', 'revoir mon calendrier PSUR')."
triggers:
  - MDR compliance
  - EU MDR

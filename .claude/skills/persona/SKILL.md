---
name: persona
description: "Générer des personas utilisateurs basés sur les données pour la recherche UX et la conception produit. Utilisation : /persona generate [options]"
---

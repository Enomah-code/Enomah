...
description: "Bilan de santé organisationnel transversal combinant les signaux de tous les rôles de la suite C. Évalue 8 dimensions sur une échelle de feux tricolores avec des recommandations détaillées. À utiliser lors de l'évaluation de la santé globale de l'entreprise, de la préparation des revues conseil d'administration, de l'identification des fonctions à risque, ou quand l'utilisateur mentionne santé organisationnelle, bilan de santé ou tableau de bord de santé."
license: MIT
metadata:
  version: 1.0.0

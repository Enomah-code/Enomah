---
name: "agent-protocol"
description: "Protocole de communication inter-agents pour les équipes d'agents de direction. Définit la syntaxe d'invocation, la prévention des boucles, les règles d'isolation et les formats de réponse. À utiliser quand des agents de direction doivent se consulter mutuellement, coordonner une analyse transversale ou animer des réunions de conseil avec plusieurs rôles d'agents."
license: MIT
metadata:
  version: 1.0.0

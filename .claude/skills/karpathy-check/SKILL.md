---
name: karpathy-check
description: "Exécute la revue selon les 4 principes de Karpathy sur les modifications en attente ou le dernier commit. Vérifie la complexité, le bruit dans le diff, les hypothèses implicites et la vérification des objectifs. Usage : /karpathy-check [--last-commit]"
---

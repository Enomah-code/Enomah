...
description: "Agent product owner agile pour la décomposition d'épics, la planification de sprints, le raffinement du backlog et la génération de user stories conformes aux critères INVEST. À utiliser lors de la préparation du travail pour une équipe de développement — par exemple, décomposer un large épic en stories conformes INVEST avec critères d'acceptation, ou affiner un backlog désorganisé avant une planification de sprint."

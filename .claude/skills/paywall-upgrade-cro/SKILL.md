...
description: "Quand l'utilisateur souhaite créer ou optimiser des paywalls intégrés à l'application, des écrans de mise à niveau, des modales d'upsell ou des verrous de fonctionnalités. Utiliser aussi quand l'utilisateur mentionne \"paywall\", \"écran de mise à niveau\", \"modale de mise à niveau\", \"upsell\", \"verrou de fonctionnalité\", \"convertir les gratuits en payants\", \"conversion freemium\", \"écran d'expiration d'essai\", \"écran de limite atteinte\", \"invite de mise à niveau de plan\" ou \"tarification intégrée\". Distinct des pages de tarification publiques (voir page-cro) — ce skill se concentre sur les moments de mise à niveau dans le produit où l'utilisateur a déjà expérimenté de la valeur."
license: MIT
metadata:
  version: 1.0.0

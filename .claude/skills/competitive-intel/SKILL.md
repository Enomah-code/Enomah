...
description: "Suivi systématique des concurrents qui alimente le positionnement du CMO, les battlecards du CRO et les décisions de feuille de route du CPO. À utiliser lors de l'analyse des concurrents, de la construction de battlecards de vente, du suivi des mouvements du marché, du positionnement face aux alternatives, ou lorsque l'utilisateur mentionne l'intelligence concurrentielle, l'analyse concurrentielle, la recherche sur les concurrents, les battlecards, win/loss ou le positionnement marché."
license: MIT
metadata:
  version: 1.0.0

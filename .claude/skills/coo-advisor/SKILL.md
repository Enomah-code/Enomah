---
name: "coo-advisor"
description: "Leadership opérationnel pour les entreprises en croissance. Conception de processus, exécution des OKR, cadence opérationnelle et plans de mise à l'échelle. Utiliser lors de la conception des opérations, la mise en place des OKR, la construction de processus, la mise à l'échelle des équipes, l'analyse des goulots d'étranglement, la planification de la cadence opérationnelle, ou quand l'utilisateur mentionne COO, opérations, amélioration des processus, OKR, mise à l'échelle, efficacité opérationnelle ou exécution."
license: MIT
metadata:
  version: 1.0.0

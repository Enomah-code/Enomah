---
name: "chro-advisor"
description: "Leadership RH pour les entreprises en croissance. Stratégie de recrutement, conception de la rémunération, structure organisationnelle, culture et rétention. À utiliser pour élaborer des plans de recrutement, concevoir des grilles de rémunération, restructurer des équipes, gérer la performance, construire la culture, ou lorsque l'utilisateur mentionne CHRO, RH, stratégie people, talent, effectifs, rémunération, design organisationnel, rétention ou gestion de la performance."
license: MIT
metadata:
  version: 1.0.0

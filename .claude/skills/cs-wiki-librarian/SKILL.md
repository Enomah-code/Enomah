...
description: "Sous-agent délégué qui répond aux requêtes sur un vault Wiki LLM. Lit d'abord index.md, explore 3 à 10 pages pertinentes par catégorie, synthétise une réponse avec des citations [[wikilink]] intégrées, et propose de consigner la réponse dans le wiki comme nouvelle page de comparaison ou de synthèse. À invoquer quand l'utilisateur pose une question substantielle à laquelle le wiki pourrait répondre, demande « que dit le wiki sur X », « compare A et B dans mes sources », ou souhaite explorer un sujet."

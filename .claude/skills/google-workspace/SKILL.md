...
description: "Opérations CLI Google Workspace : diagnostics de configuration, audit de sécurité, découverte de recettes et analyse des sorties. Utilisation : /google-workspace <setup|audit|recipe|analyze> [options]"

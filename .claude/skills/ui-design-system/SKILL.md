...
description: "Boîte à outils de système de design UI pour Senior UI Designer incluant la génération de tokens de design, la documentation des composants, les calculs de design responsive et les outils de passation aux développeurs. À utiliser pour créer des systèmes de design, générer des tokens de design, maintenir la cohérence visuelle ou faciliter la collaboration design-développement et la passation aux développeurs."
---

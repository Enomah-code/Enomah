---
name: "self-eval"
description: "Évalue honnêtement la qualité du travail de l'IA à l'aide d'un système de notation à deux axes. À utiliser après avoir terminé une tâche, une revue de code ou une session de travail pour obtenir une évaluation impartiale. Détecte l'inflation des scores, force un raisonnement en contradiction et persiste les scores entre les sessions."
license: "MIT"
---

---
name: "playwright-pro"
description: "Boîte à outils de tests Playwright de qualité production. À utiliser lorsque l'utilisateur mentionne des tests Playwright, des tests de bout en bout, l'automatisation de navigateurs, la correction de tests instables, la migration de tests, les tests CI/CD ou les suites de tests. Génère des tests, corrige les échecs instables, migre depuis Cypress/Selenium, synchronise avec TestRail, exécute sur BrowserStack. 55 templates, 3 agents, rapports intelligents."
---

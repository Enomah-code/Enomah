...
description: "Assemble des présentations complètes pour les conseils d'administration et les mises à jour investisseurs en intégrant les perspectives de tous les rôles de direction. À utiliser lors de la préparation de réunions de conseil, de mises à jour investisseurs, de bilans trimestriels ou de narratifs de levée de fonds. Couvre la structure, le cadre narratif, la communication de mauvaises nouvelles et les erreurs courantes."
license: MIT
metadata:
  version: 1.0.0

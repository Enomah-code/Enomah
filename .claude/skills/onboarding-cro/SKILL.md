---
name: "onboarding-cro"
description: "Quand l'utilisateur veut optimiser l'onboarding post-inscription, l'activation utilisateur, la première expérience d'utilisation ou le délai de création de valeur. À utiliser aussi quand l'utilisateur mentionne 'flux d'onboarding', 'taux d'activation', 'activation utilisateur', 'première expérience', 'états vides', 'checklist d'onboarding', 'moment aha' ou 'expérience nouvel utilisateur'. Pour l'optimisation de l'inscription/enregistrement, voir signup-flow-cro. Pour les séquences d'e-mails récurrentes, voir email-sequence."
license: MIT
metadata:
  version: 1.0.0

...
description: "Conçoit des stratégies d'observabilité prêtes pour la production en combinant métriques, logs et traces. Inclut la conception SLI/SLO, la surveillance des signaux dorés, l'optimisation des alertes. À utiliser lors de l'ajout d'observabilité à un nouveau service, de la refonte d'alertes trop bruyantes, ou de la conception d'un programme SLO avant la mise à l'échelle de la charge de production."
---

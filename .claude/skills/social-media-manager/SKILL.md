...
description: "Quand l'utilisateur veut développer une stratégie réseaux sociaux, planifier des calendriers éditoriaux, gérer l'engagement communautaire, ou développer sa présence sociale sur les plateformes. À utiliser aussi quand l'utilisateur mentionne « stratégie réseaux sociaux », « calendrier social », « gestion de communauté », « plan réseaux sociaux », « gagner des abonnés », « taux d'engagement », « audit réseaux sociaux » ou « quelles plateformes devrais-je utiliser ». Pour la rédaction de posts sociaux individuels, voir social-content. Pour l'analyse de données de performance sociale, voir social-media-analyzer."
license: MIT
metadata:
  version: 1.0.0

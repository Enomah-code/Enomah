...
description: "Utiliser quand une startup est approchée par un partenaire potentiel et qu'il faut décider : faut-il signer ce partenaire, à quel niveau de partenariat (référence / revendeur / OEM / SI-conseil / alliance stratégique), avec quel engagement GTM conjoint, et avec quelle part de revenus. Classe le niveau de partenariat à partir des preuves de demande indépendante vs. la recherche de conditions préférentielles, conçoit un plan GTM conjoint sur 90 jours, modélise le partage des revenus par rapport à la marge de vente directe, et met en évidence les critères d'arrêt pour clôturer les partenariats sous-performants. Pour les Responsables Partenariats, Responsables BD et PDG-Fondateurs travaillant sur des accords de revendeur, des contrats OEM ou des revues d'alliance stratégique — pas pour l'activation de vente technique, ni l'économie des coûts de canal, ni les fusions-acquisitions."
version: 2.8.0

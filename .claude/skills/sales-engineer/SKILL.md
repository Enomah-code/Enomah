---
name: "sales-engineer"
description: "Analyse les réponses aux appels d'offres (RFP/RFI) pour détecter les lacunes de couverture, construit des matrices comparatives de fonctionnalités concurrentielles et planifie des engagements de preuve de concept (POC) pour l'ingénierie avant-vente. À utiliser pour répondre à des appels d'offres, des soumissions ou des demandes de propositions ; comparer les fonctionnalités produit face aux concurrents ; planifier ou évaluer un POC client ou une démo commerciale ; préparer une proposition technique ; ou effectuer une analyse concurrentielle win/loss. Traite les tâches décrites comme 'réponse à appel d'offres', 'réponse à soumission', 'réponse à proposition', 'comparaison concurrentielle', 'matrice de fonctionnalités', 'planification de POC', 'préparation de démo commerciale' ou 'ingénierie avant-vente'."
---

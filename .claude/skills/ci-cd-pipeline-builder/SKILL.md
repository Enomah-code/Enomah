...
description: "Génère des pipelines CI/CD pragmatiques à partir des signaux détectés dans la stack du projet — génération rapide d'une base fonctionnelle, vérifications reproductibles, étapes de déploiement adaptées à l'environnement. À utiliser pour mettre en place la CI d'un nouveau projet, refactoriser des pipelines existants ou standardiser les workflows de déploiement sur plusieurs dépôts."
---

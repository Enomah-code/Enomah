---
name: "cross-eval"
description: "/cs:cross-eval <memo> — Consensus multi-modèles sur une note de conseil d'administration ou un brief stratégique. Revue croisée Claude + Codex + Gemini avec dégradation gracieuse. À utiliser lorsqu'une note à fort enjeu nécessite une vérification indépendante avant le conseil — par exemple, un pivot décisif pour l'entreprise ou des conditions de levée de fonds."
---

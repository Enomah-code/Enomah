---
name: internal-comms
description: "Utiliser lorsqu'un responsable People Ops, BizOps ou Communications Internes doit rédiger et séquencer une communication interne de gestion du changement — une annonce de réorganisation, un déploiement d'outil, un changement de politique, une transition de direction, un licenciement, une clôture d'acquisition ou un lancement de produit interne — et que l'audience est composée d'employés (pas de clients). Associe Prosci ADKAR et le modèle de changement en 8 étapes de Kotter avec des outils Python déterministes stdlib uniquement pour produire un calendrier de points de contact séquencés, une annonce principale conforme à Kotter, une FAQ segmentée par audience et des points de discussion en cascade pour les managers ; ajusté par secteur via --profile {tech-startup, scaleup, enterprise, public-company, non-profit}. Déclenché par « annonce d'assemblée générale », « comms de changement », « comms de déploiement », « annonce de réorganisation », « points de discussion des managers », « comms de licenciement »."
version: 2.8.0

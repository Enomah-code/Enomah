---
name: "agenthub"
description: "Plugin de collaboration multi-agents qui lance N sous-agents parallèles en compétition sur la même tâche via l'isolation par git worktree. Les agents travaillent indépendamment, les résultats sont évalués par métrique ou juge LLM, et la meilleure branche est fusionnée. À utiliser quand : l'utilisateur souhaite essayer plusieurs approches en parallèle — optimisation de code, variations de contenu, exploration de recherche, ou toute tâche bénéficiant d'une compétition parallèle. Prérequis : un dépôt git."
license: MIT
metadata:
  version: 2.1.2

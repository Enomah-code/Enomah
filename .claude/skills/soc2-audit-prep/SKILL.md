...
description: "/cs:soc2-audit-prep <périmètre> — Interrogation de préparation SOC 2 Type II en 6 questions décisives. Axée sur la période d'observation. À utiliser avant le début de l'observation Type II, comme point de contrôle en milieu de période, ou pour la préparation pré-test-terrain au mois 10."
---

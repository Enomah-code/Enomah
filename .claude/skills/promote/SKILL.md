---
name: "promote"
description: "Fait passer un pattern éprouvé de la mémoire automatique (MEMORY.md) vers CLAUDE.md ou .claude/rules/ pour une application permanente. À utiliser quand l'utilisateur exécute /si:promote ou demande à rendre permanent un comportement appris."
---

...
description: "Agent Ingénieur Senior pour les décisions d'architecture, la revue de code, le DevOps et la conception d'API. Orchestre les compétences d'ingénierie et d'équipe d'ingénierie pour les travaux d'implémentation technique. À invoquer quand les utilisateurs ont besoin de conception de systèmes, de revue de qualité de code, de mise en place de pipeline CI/CD ou de décisions d'infrastructure."
skills: engineering
domain: engineering
model: sonnet

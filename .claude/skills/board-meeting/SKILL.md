---
name: "board-meeting"
description: "Protocole de réunion du conseil d'administration multi-agents pour les décisions stratégiques. Exécute une délibération structurée en 6 phases : chargement du contexte, contributions indépendantes de la direction (isolées, sans pollinisation croisée), analyse critique, synthèse, revue du fondateur et extraction des décisions. À utiliser lorsque l'utilisateur invoque /cs:boardroom, convoque une réunion du conseil ou souhaite une délibération exécutive multi-perspective structurée sur une question stratégique."
license: MIT
metadata:
  version: 1.0.0

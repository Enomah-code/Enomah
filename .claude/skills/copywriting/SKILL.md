---
name: "copywriting"
description: "Quand l'utilisateur souhaite rédiger, réécrire ou améliorer le copy marketing pour toute page — y compris homepage, landing pages, pages de tarification, pages de fonctionnalités, pages à propos ou pages produit. Utiliser également quand l'utilisateur dit \\"rédige le copy pour\\", \\"améliore ce copy\\", \\"réécris cette page\\", \\"copy marketing\\", \\"aide pour les titres\\" ou \\"copy pour le CTA\\". Pour le copy email, voir email-sequence. Pour le copy de popups, voir popup-cro."
license: MIT
metadata:
  version: 1.0.0

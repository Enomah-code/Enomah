...
description: "À utiliser quand l'utilisateur demande à concevoir des schémas de base de données, planifier des migrations de données, optimiser des requêtes, choisir entre SQL et NoSQL, ou modéliser des relations entre données."
---

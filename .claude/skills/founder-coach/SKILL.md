---
name: "founder-coach"
description: "Développement personnel du leadership pour les fondateurs et PDG en première fonction. Couvre l'identification des archétypes de fondateur, les cadres de délégation, la gestion de l'énergie, les audits d'agenda de PDG, l'évolution du style de leadership, l'identification des angles morts, le syndrome de l'imposteur, la santé mentale des fondateurs et la planification de la succession. À utiliser quand un fondateur se sent être le goulot d'étranglement, a du mal à déléguer, s'épuise, passe du statut de contributeur individuel à celui de dirigeant, gère un conseil d'administration, ou quand l'utilisateur mentionne le mode fondateur, la croissance de PDG, le développement du leadership, la délégation, le burn-out ou le syndrome de l'imposteur."
license: MIT
metadata:
  version: 1.0.0

---
name: "context-engine"
description: "Charge et gère le contexte de l'entreprise pour tous les skills de conseillers de direction. Lit ~/.claude/company-context.md, détecte les contextes obsolètes (> 90 jours), enrichit le contexte au fil des conversations, et applique les règles de confidentialité/anonymisation avant les appels d'API externes. Utiliser au démarrage de toute session de conseil de direction, quand le contexte semble obsolète ou manquant, ou avant d'envoyer des données d'entreprise à un service externe."
license: MIT
metadata:
  version: 1.0.0

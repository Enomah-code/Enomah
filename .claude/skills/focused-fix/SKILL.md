---
name: "focused-fix"
description: "À utiliser lorsque l'utilisateur demande à corriger, déboguer ou faire fonctionner de bout en bout une fonctionnalité, un module ou une zone spécifique. Se déclenche sur : « faire fonctionner X », « corriger la fonctionnalité Y », « le module Z est cassé », « se concentrer sur [zone] ». Non destiné aux corrections rapides de bugs isolés — ceci est conçu pour une réparation systématique et approfondie couvrant tous les fichiers et dépendances."
---

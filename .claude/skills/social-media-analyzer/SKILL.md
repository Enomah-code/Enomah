...
description: "Analyse de campagnes réseaux sociaux et suivi des performances. Calcule les taux d'engagement, le ROI et les benchmarks par plateforme. À utiliser pour analyser les performances sur les réseaux sociaux, calculer le taux d'engagement, mesurer le ROI d'une campagne, comparer les métriques entre plateformes, ou se benchmarker par rapport aux standards du secteur. À utiliser aussi quand l'utilisateur mentionne « audit réseaux sociaux », « taux d'engagement » ou « quelle plateforme performe le mieux »."
triggers:

---
name: "tdd-guide"
description: "Compétence de développement piloté par les tests pour écrire des tests unitaires, générer des fixtures et des mocks de test, analyser les lacunes de couverture, et guider les workflows rouge-vert-refactorisation avec Jest, Pytest, JUnit, Vitest et Mocha. À utiliser lorsque l'utilisateur souhaite écrire des tests, améliorer la couverture de tests, pratiquer le TDD, générer des mocks ou des stubs, ou mentionne des frameworks de test comme Jest, pytest ou JUnit."
---

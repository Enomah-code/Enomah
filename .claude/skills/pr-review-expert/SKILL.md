...
description: "Utiliser quand l'utilisateur demande à examiner des pull requests, analyser des modifications de code, vérifier les problèmes de sécurité dans les PRs ou évaluer la qualité du code dans des diffs."
---

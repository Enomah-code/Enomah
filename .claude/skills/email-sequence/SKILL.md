---
name: "email-sequence"
description: "Lorsque l'utilisateur souhaite créer ou optimiser une séquence d'e-mails, une campagne drip, un flux d'e-mails automatisé ou un programme d'e-mails de cycle de vie. À utiliser également lorsque l'utilisateur mentionne 'séquence d'e-mails', 'campagne drip', 'séquence de nurturing', 'e-mails d'intégration', 'séquence de bienvenue', 'e-mails de ré-engagement', 'automatisation des e-mails' ou 'e-mails de cycle de vie'. Pour l'intégration in-app, voir onboarding-cro."
license: MIT
metadata:
  version: 1.0.0

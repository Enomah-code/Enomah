...
description: "Boîte à outils de recherche et design UX pour Senior UX Designer/Researcher incluant la génération de personas basée sur les données, la cartographie des parcours, les frameworks de tests d'utilisabilité et la synthèse de recherche. À utiliser pour mener des recherches utilisateurs, créer des personas, cartographier les parcours utilisateurs, planifier des tests d'utilisabilité ou valider des designs."
---

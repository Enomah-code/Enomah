---
name: "founder-mode"
description: "/cs:founder-mode <question> — Redirige automatiquement toute question de fondateur vers le bon conseiller de niveau C ou vers /cs:boardroom pour les sujets multi-rôles. Point d'entrée en commande unique. À utiliser quand un fondateur pose une question stratégique sans savoir quel conseiller ou quelle commande convient — par exemple, 'pression sur le runway' est redirigé vers le CFO, 'baisse de la rétention brute' est redirigé vers le CCO."
---

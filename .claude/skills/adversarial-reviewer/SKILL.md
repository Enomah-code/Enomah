...
description: "Revue de code adversariale qui brise la monoculture de l'auto-révision. À utiliser quand vous souhaitez une revue genuinement critique des changements récents, avant de fusionner une PR, ou quand vous suspectez que Claude est trop complaisant concernant la qualité du code. Force des changements de perspective via des personas de reviewers hostiles qui détectent les angles morts que le modèle mental de l'auteur partage avec le reviewer."
tier: "STANDARD"

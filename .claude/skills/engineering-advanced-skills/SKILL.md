...
description: "Index de 37 skills d'agents d'ingénierie avancés pour Claude Code, Codex, Gemini CLI, Cursor, OpenClaw. À utiliser pour parcourir ou choisir parmi les skills d'ingénierie de niveau PUISSANT : conception d'agents, RAG, serveurs MCP, CI/CD, conception de bases de données, observabilité, audit de sécurité, automatisation des changelogs/releases, fiabilité (SLO/chaos/flags/opérateurs), opérations plateforme."
version: 2.9.0

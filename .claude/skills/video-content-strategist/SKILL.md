...
description: "À utiliser pour planifier une stratégie de contenu vidéo, rédiger des scripts vidéo, optimiser des chaînes YouTube, construire des pipelines vidéo short-form (Reels, TikTok, Shorts) ou repurposer du contenu long format en vidéo. Déclencheurs : 'lancer une chaîne YouTube', 'stratégie de contenu vidéo', 'rédiger un script vidéo', 'repurposer en vidéo', 'YouTube SEO', 'vidéo short-form'. PAS pour du contenu blog écrit (utiliser content-production). PAS pour des légendes sociales sans vidéo (utiliser social-media-manager)."
---

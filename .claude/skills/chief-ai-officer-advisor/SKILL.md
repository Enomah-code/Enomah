...
description: "Conseil de Chief AI Officer pour les startups : décisions de construction vs. achat de modèles (API vs. fine-tuning vs. développement interne), classification des risques IA sous l'AI Act européen + le patchwork réglementaire des États américains, économie des coûts IA (point d'équilibre API vers auto-hébergement), et évolution de l'organisation de l'équipe IA. À utiliser lors de la décision d'appeler une API ou de fine-tuner, de la classification des cas d'usage IA pour le risque réglementaire, du calcul du moment où l'auto-hébergement devient rentable, du séquençage des recrutements IA, ou lorsque l'utilisateur mentionne CAIO, stratégie IA, sélection de modèles, modèle de fondation, fine-tuning, AI Act UE, NIST AI RMF, gouvernance IA, risque de modèle ou économie de l'IA. Stratégique uniquement — ne duplique pas les skills IA/ML d'ingénierie."
license: MIT
metadata:
  version: 1.0.0

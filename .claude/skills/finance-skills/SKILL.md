---
name: "finance-skills"
description: "Routeur/index pour les 2 skills financières incluses dans ce plugin : financial-analyst (analyse de ratios, valorisation DCF, analyse des écarts budgétaires, prévisions glissantes) et saas-metrics-coach (ARR/MRR, churn, CAC/LTV, NRR, quick ratio). À utiliser lorsqu'une demande financière ne correspond pas clairement à une skill et que vous devez choisir la bonne (ex. : « analyser ces états financiers », « comment vont mes métriques SaaS »)."
version: 2.9.0

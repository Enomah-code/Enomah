...
description: "Expert en création et modification de templates et fichiers Atlassian pour créer, modifier et gérer des templates Jira et Confluence, des blueprints, des mises en page personnalisées, des composants réutilisables et des structures de contenu standardisées. À utiliser pour construire des templates à l'échelle de l'organisation, des blueprints personnalisés, des mises en page et la génération de contenu automatisée."
---

---
name: "behuman"
description: "À utiliser quand l'utilisateur souhaite des réponses IA plus humaines — moins robotiques, moins sous forme de listes, plus authentiques. Déclencheurs : « behuman », « sois réel », « comme un humain », « plus humain », « moins IA », « parle comme une personne », « mode miroir », « arrête d'être si IA », ou lors de conversations chargées émotionnellement (deuil, perte d'emploi, conseils relationnels, peur). PAS pour les questions techniques, la génération de code ou les recherches factuelles."
---

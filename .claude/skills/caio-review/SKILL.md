---
name: "caio-review"
description: "/cs:caio-review <plan> — Interrogatoire exigeant en évaluation du Directeur de l'IA de tout plan impliquant de l'IA : sélection de modèle, classification des risques, économie des coûts ou recrutement IA. À utiliser lors du déploiement d'une fonctionnalité IA sans ensemble d'évaluation, du choix entre API, fine-tuning et auto-hébergement, ou de la classification d'un cas d'usage sous l'AI Act européen."
---

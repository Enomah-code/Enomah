---
name: "run"
description: "Commande de cycle de vie en une seule passe enchaînant init → baseline → spawn → eval → merge en une seule invocation. À utiliser lorsque l'utilisateur exécute /hub:run ou demande à exécuter une compétition AgentHub complète de bout en bout."
command: /hub:run
---

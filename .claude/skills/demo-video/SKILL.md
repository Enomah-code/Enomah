---
name: "demo-video"
description: "À utiliser lorsque l'utilisateur demande à créer une vidéo de démonstration, une présentation guidée du produit, une vitrine de fonctionnalités, une présentation animée, une vidéo marketing ou un GIF à partir de captures d'écran ou de descriptions de scènes. Orchestre les MCPs playwright, ffmpeg et edge-tts pour produire du contenu vidéo soigné."
---

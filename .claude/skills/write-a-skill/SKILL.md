---
name: write-a-skill
description: "Crée de nouveaux skills d'agent avec une structure appropriée, une divulgation progressive et des ressources intégrées. À utiliser quand l'utilisateur souhaite créer, rédiger, construire ou concevoir un nouveau skill."
license: MIT
metadata:

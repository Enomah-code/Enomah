---
name: "seo-audit"
description: "Quand l'utilisateur souhaite auditer, examiner ou diagnostiquer des problèmes SEO sur son site. À utiliser aussi quand l'utilisateur mentionne « audit SEO », « SEO technique », « pourquoi je ne me classe pas », « problèmes SEO », « SEO on-page », « revue des balises meta » ou « bilan de santé SEO ». Pour construire des pages à grande échelle afin de cibler des mots-clés, voir programmatic-seo. Pour ajouter des données structurées, voir schema-markup."
license: MIT
metadata:
  version: 1.0.0

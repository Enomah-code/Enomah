...
description: "Génère des documents professionnels adaptés aux juridictions : contrats freelance, propositions de projet, SoW, NDA et MSA. Sortie en Markdown structuré avec instructions de conversion en docx. Couvre les juridictions US (Delaware), UE (RGPD), Royaume-Uni et DACH (droit allemand). Ne remplace pas un conseil juridique — à utiliser comme bases de départ solides. Utiliser lors de la rédaction d'un contrat freelance, de la préparation d'une proposition client, de la rédaction d'un SoW pour un nouvel engagement, ou de la production d'un NDA avant de partager des informations sensibles."
---

---
name: tc
description: "Suivre les changements techniques avec des enregistrements structurés, une machine à états et un transfert de session. Utilisation : /tc <init|create|update|status|resume|close|export|dashboard> [args]"
---

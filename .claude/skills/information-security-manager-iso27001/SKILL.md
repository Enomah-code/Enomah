...
description: "Mise en œuvre du SMSI ISO 27001 et gouvernance de la cybersécurité pour les entreprises HealthTech et MedTech. Utiliser lors de la conception d'un SMSI, de l'exécution d'évaluations des risques de sécurité, de la mise en œuvre de contrôles, de la poursuite de la certification ISO 27001, de la préparation d'audits de sécurité, de la réponse aux incidents de sécurité, ou de la vérification de la conformité. Couvre ISO 27001, ISO 27002, la sécurité des soins de santé et la cybersécurité des dispositifs médicaux."
---

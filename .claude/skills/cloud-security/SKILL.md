---
name: "cloud-security"
description: "À utiliser pour évaluer les infrastructures cloud en matière de mauvaises configurations de sécurité, de chemins d'escalade de privilèges IAM, d'exposition publique S3, de règles de groupes de sécurité ouvertes ou de lacunes de sécurité dans l'IaC. Couvre l'évaluation de posture AWS, Azure et GCP avec cartographie MITRE ATT&CK."
---

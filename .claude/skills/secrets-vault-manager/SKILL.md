...
description: "À utiliser quand l'utilisateur souhaite mettre en place une infrastructure de gestion des secrets, intégrer HashiCorp Vault, configurer des gestionnaires de secrets cloud (AWS Secrets Manager, Azure Key Vault, GCP Secret Manager), implémenter la rotation des secrets ou auditer les patterns d'accès aux secrets."
---

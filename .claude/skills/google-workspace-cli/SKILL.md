...
description: "Administration de Google Workspace via le CLI gws (github.com/googleworkspace/cli). Installez, authentifiez et automatisez Gmail, Drive, Sheets, Calendar, Docs, Chat et Tasks. Exécutez des audits de sécurité et utilisez des modèles de recettes locales et des bundles de personas. À utiliser pour l'administration de Google Workspace, la configuration du CLI gws, l'automatisation de Gmail, la gestion de Drive ou la planification dans Calendar."
---

---
description: "Revue d'ingénierie fullstack — parcourt les 7 questions de cadrage de Matt Pocock, sélectionne le profil, délègue aux spécialistes POWERFUL (api-design-reviewer, database-designer, slo-architect). Invoque l'agent cs-fullstack-engineer avec un fork de contexte."

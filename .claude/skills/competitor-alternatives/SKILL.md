...
description: "Quand l'utilisateur souhaite créer des pages de comparaison de concurrents ou d'alternatives pour le référencement et l'aide à la vente. Utiliser également quand l'utilisateur mentionne 'page alternative', 'page vs', 'comparaison de concurrents', 'page de comparaison', '[Produit] vs [Produit]', 'alternative à [Produit]', 'landing pages concurrentielles', 'passer d'un concurrent' ou 'contenu comparatif'. Couvre quatre formats : alternative singulière, alternatives plurielles, vous vs concurrent, et concurrent vs concurrent. Met l'accent sur la recherche approfondie, l'architecture de contenu modulaire, et des types de sections variés au-delà des tableaux de fonctionnalités."
license: MIT
metadata:
  version: 1.0.0

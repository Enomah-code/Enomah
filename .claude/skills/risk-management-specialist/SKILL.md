...
description: "Spécialiste en gestion des risques pour dispositifs médicaux, implémentant la norme ISO 14971 tout au long du cycle de vie du produit. Fournit l'analyse des risques, l'évaluation des risques, la maîtrise des risques et l'analyse des informations post-production. À utiliser lorsque l'utilisateur mentionne la gestion des risques, ISO 14971, l'analyse des risques, l'AMDEC, l'analyse par arbre de défaillances, l'identification des dangers, la maîtrise des risques, la matrice des risques, l'analyse bénéfice-risque, le risque résiduel, l'acceptabilité du risque ou le risque post-commercialisation."
---

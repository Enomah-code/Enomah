...
Name: claude-coach
name: claude-coach
description: "Coach personnel qui apprend aux utilisateurs à devenir des utilisateurs avancés de Claude. Utiliser cette compétence la PREMIÈRE fois qu'un utilisateur demande à 'apprendre Claude', 'devenir un utilisateur avancé', 'me coacher', 'm'apprendre des astuces Claude', 'que peut faire Claude', 'améliorer mon prompting', ou toute variation. Après activation, l'utiliser également à CHAQUE tour suivant pour détecter les opportunités d'optimisation manquées (prompts vagues, fonctionnalités ignorées, tâches manuelles que Claude pourrait automatiser) et proposer un conseil d'utilisateur avancé. Déclencher généreusement — la plupart des utilisateurs ne savent pas ce qu'ils ne savent pas, donc pencher vers le coaching."
Tier: POWERFUL
Category: meta

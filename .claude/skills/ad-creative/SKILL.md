---
name: "ad-creative"
description: "Quand l'utilisateur a besoin de générer, itérer ou produire à grande échelle des créations publicitaires pour la publicité payante. À utiliser lorsqu'il dit « rédiger du texte publicitaire », « générer des titres », « créer des variantes d'annonces », « créations en masse », « itérer sur des annonces », « validation de texte publicitaire », « titres RSA », « texte publicitaire Meta », « annonce LinkedIn » ou « tests créatifs ». Il s'agit de production créative pure — distinct de paid-ads (stratégie de campagne). Utiliser ad-creative quand vous avez besoin du texte, pas du plan de campagne."
license: MIT
metadata:
  version: 1.0.0

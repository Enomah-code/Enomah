...
description: "Orchestrateur d'ingénierie frontend. Parcourt les 7 questions de cadrage de Matt Pocock (appareil, cible LCP, rendu, budget de bundle, SEO vs auth, système de design, WCAG), sélectionne le profil de framework/rendu, délègue aux spécialistes (a11y-audit, apple-hig-expert, epic-design, performance-profiler, playwright-pro — listés alphabétiquement ; l'ordre du workflow est piloté par les dépendances) plutôt que de réimplémenter leur périmètre. Crée son propre contexte. À invoquer via /cs:frontend-review ou Agent({subagent_type:\"cs-frontend-engineer\",...})."

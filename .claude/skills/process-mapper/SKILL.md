---
name: process-mapper
description: "À utiliser quand un responsable BizOps, un COO ou un propriétaire d'amélioration des processus doit documenter un processus métier de bout en bout (approvisionnement, onboarding des employés, transfert d'incident, onboarding client, traitement des sinistres) en notation de style BPMN, mesurer les temps de cycle par étape, identifier où le travail passe le plus de temps en attente vs en traitement, et quantifier l'écart entre le temps de traitement et le temps écoulé total. Combine les référentiels Lean / Six Sigma / Théorie des Contraintes avec des outils Python déterministes de bibliothèque standard pour produire une cartographie des processus, une liste de goulots d'étranglement classés (avec sévérité et hypothèse de cause racine), et une analyse des temps de cycle (P50, P90, ratio valeur ajoutée, débit selon la Loi de Little). Distinct du pipeline commercial, de la fiabilité système (SLO) et du travail OKR stratégique — il s'agit de documentation tactique des processus pour les opérations internes."
version: 2.8.0

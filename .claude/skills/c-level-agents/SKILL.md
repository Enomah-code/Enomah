---
name: "c-level-agents"
description: "Équipe dirigeante en mode fondateur. 13 agents cs-* de direction (CFO, CMO, CRO, CPO, COO, CHRO, CISO, GC, CDO, CAIO, CCO, VPE, Chief of Staff) et 21 commandes slash /cs:* pour des office hours à questions directes, une délibération en salle du conseil multi-rôles, un pipeline de sprint stratégique et un routage méta. À utiliser lorsque le fondateur a besoin d'une équipe dirigeante virtuelle, lors de l'invocation de commandes /cs:*, ou lors de l'orchestration de décisions multi-rôles."
license: MIT
metadata:
  version: 1.0.0

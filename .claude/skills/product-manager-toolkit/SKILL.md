...
description: "Boîte à outils complète pour les product managers incluant la priorisation RICE, l'analyse des entretiens clients, les modèles de PRD, les frameworks de discovery et les stratégies de mise sur le marché. À utiliser lors de la priorisation des fonctionnalités, de la synthèse de la recherche utilisateur, de la rédaction de documentation des exigences, ou du développement de la stratégie produit."
---

---
name: "gc-review"
description: "/cs:gc-review <plan> — Interrogatoire du Directeur Juridique sur les contrats, la propriété intellectuelle, la réglementation, les term sheets et le droit du travail. À utiliser lors de la revue d'un term sheet avant signature, de la révision d'un MSA client, ou de la vérification des clauses de cession de PI et de l'exposition réglementaire d'un nouveau produit."
---

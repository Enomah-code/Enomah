---
name: "execute"
description: "/cs:execute <décision> — Génère un plan d'exécution sur 90 jours avec des jalons hebdomadaires, des DRI (responsables directement impliqués) et une cadence de suivi à partir d'une décision approuvée. À utiliser lorsqu'une décision enregistrée doit devenir un plan opérationnel — par exemple, transformer une décision d'entrée sur un marché approuvée en jalons hebdomadaires avec DRI."
---

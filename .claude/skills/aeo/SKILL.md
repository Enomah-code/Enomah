---
name: aeo
description: "Compétence d'optimisation pour les moteurs de réponse (AEO) — optimiser le contenu pour être cité par les modèles de langage IA (ChatGPT, Perplexity, Claude, Gemini, Mistral) comme sources faisant autorité. Distinct du SEO — l'AEO optimise pour la citation dans les réponses générées par LLM, pas pour le classement dans les moteurs de recherche. À utiliser lors de la planification de contenu pour des audiences axées sur la recherche IA, l'audit de contenu existant pour les signaux E-E-A-T, le suivi des pages citées par quels LLMs, ou la construction d'une stratégie de contenu favorable aux citations. Déclencheurs — « audit AEO », « optimiser pour ChatGPT », « être cité par Perplexity », « stratégie de citation LLM », « optimisation pour les moteurs de réponse », « contenu pour la recherche IA », « audit E-E-A-T ». La sortie est un rapport d'audit en markdown (par défaut) ou JSON pour l'intégration dans des pipelines. Outils Python stdlib uniquement."
---

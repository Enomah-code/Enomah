...
description: "Analyse les performances de campagne avec attribution multi-touch, analyse de conversion d'entonnoir et calcul du ROI pour l'optimisation marketing. À utiliser pour analyser des campagnes marketing, les performances publicitaires, les modèles d'attribution, les taux de conversion ou pour calculer le ROI marketing, ROAS, CPA et les métriques de campagne sur tous les canaux."
license: MIT
metadata:
  version: 1.0.0

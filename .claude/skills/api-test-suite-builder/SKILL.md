...
description: "À utiliser quand l'utilisateur demande à générer des tests d'API, créer des suites de tests d'intégration, tester des endpoints REST ou construire des tests de contrat."
---

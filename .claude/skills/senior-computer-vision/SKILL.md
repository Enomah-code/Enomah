...
description: "Compétence d'ingénierie en vision par ordinateur pour la détection d'objets, la segmentation d'images et les systèmes d'IA visuelle. Couvre les architectures CNN et Vision Transformer, la détection YOLO/Faster R-CNN/DETR, la segmentation Mask R-CNN/SAM et le déploiement en production avec ONNX/TensorRT. Inclut les frameworks PyTorch, torchvision, Ultralytics, Detectron2 et MMDetection. À utiliser pour construire des pipelines de détection, entraîner des modèles personnalisés, optimiser l'inférence ou déployer des systèmes de vision."
---

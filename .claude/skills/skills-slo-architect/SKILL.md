---
name: slo-architect
description: "À utiliser lors de la définition, de la révision ou de l'exploitation de SLOs/SLIs/budgets d'erreur. Se déclenche sur « define an SLO », « what should our SLO be », « error budget », « burn rate », « SLI », « service level objective », « Google SRE workbook », « multi-window burn-rate alert », ou toute question sur les cibles de fiabilité. Fournit un concepteur de SLO, un calculateur de budget d'erreur avec seuils de taux de combustion multi-fenêtres, et un réviseur de SLO détectant les erreurs courantes (cible trop agressive, fenêtre trop courte, SLOs conflictuels, absence de définition de SLI). 4 références sur les principes des SLO + conception des SLI + calcul du budget d'erreur + composition avec feature-flags-architect/chaos-engineering/kubernetes-operator. PAS un skill d'observabilité générique — spécifiquement la discipline SLO."
context: fork
version: 2.9.0

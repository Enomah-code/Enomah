---
name: slo-architect
description: "À utiliser pour définir, réviser ou exploiter des SLO/SLI/budgets d'erreur. Se déclenche sur « définir un SLO », « quel devrait être notre SLO », « budget d'erreur », « taux de consommation », « SLI », « objectif de niveau de service », « Google SRE workbook », « alerte multi-fenêtre burn-rate », ou toute question relative aux cibles de fiabilité. Fournit un concepteur de SLO, un calculateur de budget d'erreur avec seuils de burn-rate multi-fenêtres, et un réviseur de SLO qui détecte les erreurs courantes (cible trop agressive, fenêtre trop courte, SLO conflictuels, absence de définition SLI). 4 références sur les principes SLO + conception SLI + calcul du budget d'erreur + composition avec feature-flags-architect/chaos-engineering/kubernetes-operator. N'est PAS un skill d'observabilité générique — spécifiquement la discipline SLO."
context: fork
version: 2.9.0

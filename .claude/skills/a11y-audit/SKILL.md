---
name: "a11y-audit"
description: "Compétence d'audit d'accessibilité pour analyser, corriger et vérifier la conformité WCAG 2.2 niveaux A et AA sur des bases de code React, Next.js, Vue, Angular, Svelte et HTML pur. À utiliser lors d'un audit d'accessibilité, pour corriger des violations a11y, vérifier le contraste des couleurs, générer des rapports de conformité ou intégrer des contrôles d'accessibilité dans des pipelines CI/CD."
---

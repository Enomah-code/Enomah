---
name: "post-mortem"
description: "/cs:post-mortem <décision> — Rétrospective honnête sur une décision exécutée, évaluée par rapport aux hypothèses initiales et aux dissidences. Clôture la boucle du sprint stratégique. Utiliser quand une décision atteint son point de revue à 90 jours ou que ses critères d'arrêt se déclenchent — ex. : évaluer le changement de tarification du trimestre dernier par rapport à ses métriques de succès prédéfinies."
---

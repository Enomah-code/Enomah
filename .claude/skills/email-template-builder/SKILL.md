...
description: "Construit des systèmes d'e-mails transactionnels complets : templates React Email, intégration de fournisseurs (Resend, Postmark, SendGrid, AWS SES), serveur de prévisualisation, support i18n, mode sombre, optimisation anti-spam, suivi analytique. À utiliser lors de l'ajout d'e-mails transactionnels à un nouveau produit, de la migration entre fournisseurs d'e-mails, de la refactorisation de templates d'e-mails hérités pour l'accessibilité, ou de l'ajout de l'internationalisation à des templates existants."
---

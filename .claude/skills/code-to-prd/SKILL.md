---
name: code-to-prd
description: "Rétro-ingénierie de n'importe quelle base de code en un Document de Spécifications Produit (PRD) complet. Analyse les routes, composants, gestion d'état, intégrations API et interactions utilisateur pour produire une documentation lisible par les équipes métier, suffisamment détaillée pour que les ingénieurs ou agents IA puissent reconstruire intégralement chaque page et endpoint. Compatible avec les frameworks frontend (React, Vue, Angular, Svelte, Next.js, Nuxt), les frameworks backend (NestJS, Django, Express, FastAPI) et les applications fullstack. À utiliser lorsque les utilisateurs mentionnent : générer un PRD, rétro-ingénierie des exigences, code vers documentation, extraire les spécifications produit du code, documenter la logique des pages, analyser les champs et interactions des pages, créer un inventaire fonctionnel, rédiger des exigences depuis une base de code existante, documenter les endpoints API ou analyser les routes backend."
license: MIT
metadata:
  updated: 2026-03-17
  tier: STANDARD

---
name: "setup"
description: "Configure une nouvelle expérience d'autorecherche de manière interactive. Collecte le domaine, le fichier cible, la commande d'évaluation, la métrique, la direction et l'évaluateur. À utiliser quand l'utilisateur exécute /ar:setup ou demande à démarrer l'optimisation d'un fichier avec la boucle d'autorecherche."
command: /ar:setup
---

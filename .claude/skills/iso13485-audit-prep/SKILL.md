...
description: "/cs:iso13485-audit-prep <périmètre> — Interrogatoire de forçage en 6 questions pour l'audit QMS ISO 13485. Axé sur les contrôles de conception + CAPA + surveillance post-marché. À utiliser avant un audit interne de la Clause 8.2.4, une revue d'alignement MDR / FDA QSR, ou un audit de clôture DHF avant lancement produit."
---

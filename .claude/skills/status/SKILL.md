---
name: "status"
description: "Tableau de bord de santé de la mémoire affichant le nombre de lignes, les fichiers thématiques, la capacité, les entrées obsolètes et des recommandations. À utiliser lorsque l'utilisateur exécute /si:status ou demande le niveau de remplissage ou l'état de santé de la mémoire de l'agent."
---

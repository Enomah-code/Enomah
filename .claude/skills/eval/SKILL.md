---
name: "eval"
description: "Évalue et classe les résultats d'agents selon une métrique ou un juge LLM pour une session AgentHub. À utiliser lorsque l'utilisateur exécute /hub:eval ou demande à noter, comparer ou désigner un gagnant parmi les agents AgentHub terminés."
command: /hub:eval
---

---
name: "page-cro"
description: "Quand l'utilisateur souhaite optimiser, améliorer ou augmenter les conversions sur une page marketing — incluant la page d'accueil, les landing pages, les pages de tarification, les pages de fonctionnalités ou les articles de blog. Utiliser aussi quand l'utilisateur mentionne \"CRO\", \"optimisation du taux de conversion\", \"cette page ne convertit pas\", \"améliorer les conversions\" ou \"pourquoi cette page ne fonctionne pas\". Pour les tunnels d'inscription/enregistrement, voir signup-flow-cro. Pour l'activation post-inscription, voir onboarding-cro. Pour les formulaires hors inscription, voir form-cro. Pour les popups/modales, voir popup-cro."
license: MIT
metadata:
  version: 1.0.0

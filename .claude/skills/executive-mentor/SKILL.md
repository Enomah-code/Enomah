...
description: "Partenaire de réflexion adversarial pour les fondateurs et dirigeants. Teste les plans sous pression, prépare aux réunions de conseil d'administration les plus exigeantes, décortique les décisions sans bonne issue et impose des post-mortems honnêtes. À utiliser lorsque vous avez besoin de quelqu'un pour trouver les failles avant le conseil, prendre une décision que vous repoussez, ou comprendre ce qui s'est réellement passé."
license: MIT
metadata:
  version: 1.0.0

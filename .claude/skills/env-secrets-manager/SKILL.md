...
description: "Gère l'hygiène des variables d'environnement et la sécurité des secrets en développement local et en production. Audit pratique, détection de dérive, préparation à la rotation. À utiliser lors de l'audit des fichiers .env pour les secrets committés, de la planification d'une rotation de credentials, du débogage d'incidents de production liés à des variables d'environnement manquantes, ou du durcissement d'un nouveau projet contre les fuites de secrets."
---

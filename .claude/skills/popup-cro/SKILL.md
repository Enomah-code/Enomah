---
name: "popup-cro"
description: "Quand l'utilisateur souhaite créer ou optimiser des popups, modales, overlays, slide-ins ou bandeaux à des fins de conversion. Utiliser aussi quand l'utilisateur mentionne \"intention de sortie\", \"conversions de popup\", \"optimisation de modale\", \"popup de capture de leads\", \"popup email\", \"bandeau d'annonce\" ou \"overlay\". Pour les formulaires hors popups, voir form-cro. Pour l'optimisation générale du taux de conversion d'une page, voir page-cro."
license: MIT
metadata:
  version: 1.0.0

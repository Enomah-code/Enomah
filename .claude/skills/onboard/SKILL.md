---
name: "onboard"
description: "/cs:onboard — Interview fondateur qui alimente ~/.claude/company-context.md en utilisant le schéma canonique cs-onboard à 7 dimensions. La première commande à exécuter lors du démarrage avec c-level-agents. À utiliser lors de la mise en place de la suite C virtuelle pour une nouvelle entreprise, ou quand les conseillers manquent de contexte entreprise — ex. avant un premier /cs:boardroom ou après qu'une levée de fonds change les chiffres."
---

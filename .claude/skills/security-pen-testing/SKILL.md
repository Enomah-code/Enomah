...
description: "À utiliser quand l'utilisateur souhaite effectuer des audits de sécurité, des tests de pénétration, des analyses de vulnérabilités, des vérifications OWASP Top 10 ou des évaluations de sécurité offensive. Couvre l'analyse statique, l'analyse des dépendances, la détection de secrets, les tests de sécurité API et la génération de rapports de tests de pénétration."
---

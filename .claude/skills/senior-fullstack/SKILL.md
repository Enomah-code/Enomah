...
description: "Boîte à outils de développement fullstack avec initialisation de projets pour les stacks Next.js, FastAPI, MERN et Django, analyse de qualité de code avec scoring de sécurité et de complexité, et guide de sélection de stack. À utiliser quand l'utilisateur demande à « initialiser un nouveau projet », « créer une application Next.js », « configurer FastAPI avec React », « analyser la qualité du code », « auditer ma base de code », « quelle stack devrais-je utiliser », « générer le boilerplate du projet », ou mentionne le développement fullstack, la configuration de projet ou la comparaison de stacks technologiques."
---

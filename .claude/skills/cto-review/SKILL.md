---
name: "cto-review"
description: "/cs:cto-review <plan> — Interrogatoire d'architecture et de passage à l'échelle. Dette technique, seuils de scalabilité, croissance des équipes, build-vs-buy. À utiliser lors de l'engagement sur une architecture, de la planification pour une charge 10x, ou de l'arbitrage entre refonte et solution tierce."
---

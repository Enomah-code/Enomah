...
description: "Expert en audit de Système de Management de la Sécurité de l'Information (SMSI) pour la vérification de conformité ISO 27001, l'évaluation des contrôles de sécurité et le support à la certification. Utilisez lorsque l'utilisateur mentionne l'ISO 27001, l'audit SMSI, les contrôles de l'Annexe A, la Déclaration d'Applicabilité (DdA), l'analyse des écarts, la gestion des non-conformités, l'audit interne, l'audit de surveillance ou la préparation à la certification sécurité. Aide à examiner les preuves de mise en œuvre des contrôles, documenter les constats d'audit, classer les non-conformités, générer des plans d'audit basés sur les risques, cartographier les contrôles selon les exigences de l'Annexe A, préparer la documentation des audits de Phase 1 et Phase 2, et soutenir les workflows d'actions correctives."
triggers:
  - ISMS audit
  - ISO 27001 audit
  - security audit

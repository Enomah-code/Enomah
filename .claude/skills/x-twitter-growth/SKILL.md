...
description: "Moteur de croissance X/Twitter pour développer une audience, créer du contenu viral et analyser l'engagement. À utiliser quand l'utilisateur veut croître sur X/Twitter, rédiger des tweets ou des fils, analyser son profil X, étudier des concurrents sur X, planifier une stratégie de publication ou optimiser l'engagement. Complète social-content (multi-plateforme générique) avec une profondeur spécifique à X : mécanique algorithmique, ingénierie de fils de discussion, stratégie de réponse, optimisation du profil et intelligence concurrentielle via recherche web."
license: MIT
metadata:
  version: 1.0.0

...
description: "À utiliser lors de la revue, de l'approbation ou de la conception du mouvement commercial — modèles de tarification, revue de transactions, approbation de remises, économie des partenariats, mix de canaux, politique commerciale, réponse RFP/RFI, prévision de réservations. Se déclenche sur « revoir cette transaction », « devrions-nous accorder une remise », « modèle de tarification », « économie des partenariats », « réponse RFP », « prévision de réservations », « mix de canaux ». Bifurque le contexte pour router vers l'un des sept sous-skills Commerciaux (pricing-strategist, deal-desk, partnerships-architect, channel-economics, commercial-policy, rfp-responder, commercial-forecaster) et retourne un résumé. Distinct de business-growth (exécution des ventes) et c-level-advisor/cro-advisor (jugement stratégique CRO)."
context: fork
version: 2.8.0

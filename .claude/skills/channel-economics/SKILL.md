...
description: "À utiliser lors de la revue ou du rééquilibrage de l'économie des canaux directs vs. partenaires — calcul du coût de service entièrement chargé par canal, ROI du canal avec les lentilles trésorerie / LTV / marginal, et mix de canaux optimal sous contraintes. Pour les responsables Commercial, RevOps et VP Sales effectuant la revue trimestrielle des canaux lorsque le pipeline est mixte (ex. 60% direct + 40% partenaires) et que personne ne sait réellement quel canal est rentable après intégration du CAC, de la charge support, des remises partenaires, des différences de vélocité des transactions, du différentiel de rétention et de l'allocation des frais généraux. Produit le coût de service, les verdicts de ROI par canal (DOUBLER / MAINTENIR / RÉDUIRE / ABANDONNER), une recommandation de mix de canaux testée en sensibilité, et le point d'inflexion des rendements décroissants (ex. 'quel canal est réellement rentable — direct ou partenaire ?')."
version: 2.8.0

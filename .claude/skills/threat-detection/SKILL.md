...
description: "À utiliser pour la chasse aux menaces dans un environnement, l'analyse d'IOC (indicateurs de compromission) ou la détection d'anomalies comportementales dans la télémétrie. Couvre la chasse aux menaces pilotée par hypothèses, la génération de balayages IOC, la détection d'anomalies par z-score et la priorisation des signaux mappés sur le framework MITRE ATT&CK."
---

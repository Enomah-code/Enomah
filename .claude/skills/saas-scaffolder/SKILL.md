...
description: "Génère un boilerplate de projet SaaS complet et prêt pour la production, incluant l'authentification, les schémas de base de données, l'intégration de facturation, les routes API et un tableau de bord fonctionnel avec Next.js 14+ App Router, TypeScript, Tailwind CSS, shadcn/ui, Drizzle ORM et Stripe. À utiliser quand l'utilisateur veut créer une nouvelle application SaaS, démarrer un projet web par abonnement, scaffolder une application Next.js, ou mentionne des termes comme template de démarrage, boilerplate, nouveau projet, ou configuration de l'authentification et des paiements."
---

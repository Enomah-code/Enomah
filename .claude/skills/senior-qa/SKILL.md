---
name: "senior-qa"
description: "Génère des tests unitaires, des tests d'intégration et des tests E2E pour les applications React/Next.js. Analyse les composants pour créer des stubs de tests Jest + React Testing Library, analyse les rapports de couverture Istanbul/LCOV pour identifier les lacunes, génère des fichiers de tests Playwright à partir des routes Next.js, simule les appels API avec MSW, crée des fixtures de test et configure les exécuteurs de tests. À utiliser quand l'utilisateur demande à « générer des tests », « écrire des tests unitaires », « analyser la couverture de tests », « générer des tests E2E », « configurer Playwright », « configurer Jest », « implémenter des patterns de tests » ou « améliorer la qualité des tests »."
---

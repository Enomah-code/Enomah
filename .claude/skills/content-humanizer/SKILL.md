...
description: "Rend le contenu généré par IA véritablement humain — pas seulement nettoyé, mais vivant. Utiliser quand le contenu semble robotique, utilise trop de clichés IA, manque de personnalité, ou semble écrit par un comité. Déclencheurs : 'ça ressemble à de l'IA', 'rends-le plus humain', 'ajoute de la personnalité', 'c'est générique', 'ça sonne robotique', 'corrige l'écriture IA', 'injecte notre voix'. PAS pour la création initiale de contenu (utiliser content-production). PAS pour l'optimisation SEO (utiliser content-production Mode 3)."
license: MIT
metadata:
  version: 1.0.0

...
description: "Expert Atlassian Confluence pour la création et la gestion d'espaces, de bases de connaissances et de documentation. Configure les permissions d'espaces et les hiérarchies, crée des modèles de pages avec macros, met en place des taxonomies documentaires, conçoit des mises en page, et gère la gouvernance du contenu. Utiliser quand les utilisateurs ont besoin de construire ou restructurer un espace Confluence, concevoir des hiérarchies de pages avec des structures de permissions, rédiger ou standardiser des modèles de documentation, intégrer des rapports Jira dans des pages, réaliser des audits de base de connaissances, ou établir des standards de documentation et des flux de travail collaboratifs."
---

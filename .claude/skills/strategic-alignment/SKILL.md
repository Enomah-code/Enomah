...
description: "Décline la stratégie de la salle du conseil jusqu'au contributeur individuel. Détecte et corrige les désalignements entre les objectifs de l'entreprise et l'exécution des équipes. Couvre l'articulation de la stratégie, la cartographie de la cascade, la détection des objectifs orphelins, l'identification des silos, l'analyse des lacunes de communication et les protocoles de réalignement. À utiliser lorsque les équipes tirent dans des directions différentes, que les OKR ne sont pas connectés, que les départements optimisent localement au détriment de l'entreprise, ou lorsque l'utilisateur mentionne l'alignement, la cascade stratégique, les silos, des OKR conflictuels ou la communication de la stratégie."
license: MIT
metadata:
  version: 1.0.0

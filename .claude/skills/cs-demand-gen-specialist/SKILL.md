...
description: "Spécialiste en génération de demande et en funnel d'acquisition orchestrant les skills marketing-demand-acquisition, paid-ads et email-sequence. À utiliser lors de la construction ou de la correction du moteur d'acquisition — par exemple, comparer le CAC par canal aux benchmarks SaaS B2B avant de réallouer un budget de 40k$/mois, scorer la santé des comptes publicitaires avec ad_health_scorer.py avant de scaler les dépenses, ou concevoir une séquence de nurturing devant scorer 70+ sur sequence_analyzer.py avant le lancement. Couvre le mix de canaux, les calculs CAC/ROAS, les workflows MQL→SQL, l'attribution et la conception de nurturing."
skills:

...
description: "À utiliser lors d'un audit SaaS annuel, d'une revue des dépenses par catégorie, ou de la rationalisation du parc fournisseurs — quand l'utilisateur a besoin d'un audit des dépenses, d'une catégorisation des dépenses (alignée UNSPSC avec décomposition Pareto et profils sectoriels), d'une analyse du cycle d'achat (catégories à goulot d'étranglement selon la Théorie des Contraintes de Goldratt), ou d'une consolidation fournisseurs équilibrée par le risque qui refuse les recommandations de source unique pour les catégories de niveau 1 sans plan de secours documenté. Se déclenche sur « audit des dépenses », « audit SaaS », « catégorisation des dépenses », « rationalisation fournisseurs », « consolidation fournisseurs », « stratégie de catégorie », « SaaS en doublon », « cluster de renouvellements »."
version: 2.8.0

---
name: sprint-plan
description: "Planification de sprint avec contrôle de capacité — effectue le calcul de capacité, la vérification des reports, et un contrôle de définition de prêt avant de valider le périmètre. Utilisation : /sprint-plan <objectif> [capacité]"

---
name: "spawn"
description: "Lance N sous-agents parallèles dans des worktrees git isolés pour rivaliser sur la tâche de session. À utiliser quand l'utilisateur exécute /hub:spawn ou demande à démarrer les agents concurrents pour une session AgentHub initialisée."
command: /hub:spawn
---

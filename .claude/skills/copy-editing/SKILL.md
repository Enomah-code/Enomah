---
name: "copy-editing"
description: "Quand l'utilisateur souhaite modifier, réviser ou améliorer un copy marketing existant. Utiliser également quand l'utilisateur mentionne 'édite ce copy', 'révise mon copy', 'retour sur le copy', 'relecture', 'peaufine ça', 'améliore ça' ou 'révision du copy'. Ce skill fournit une approche systématique pour réviser le copy marketing via plusieurs passes ciblées."
license: MIT
metadata:
  version: 1.0.0

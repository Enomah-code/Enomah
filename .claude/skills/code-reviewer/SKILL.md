---
name: "code-reviewer"
description: "Automatisation de la revue de code pour TypeScript, JavaScript, Python, Go, Swift, Kotlin, C#, .NET, Java, C, C++, Rust, Ruby, PHP et Dart/Flutter. Analyse les PRs pour la complexité et le risque, vérifie la qualité du code pour les violations SOLID et les mauvaises pratiques, génère des rapports de revue. À utiliser lors de la revue de pull requests, de l'analyse de la qualité du code, de l'identification de problèmes ou de la génération de listes de contrôle de revue."
---

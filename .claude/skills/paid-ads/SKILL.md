---
name: "paid-ads"
description: "Quand l'utilisateur souhaite de l'aide avec des campagnes publicitaires payantes sur Google Ads, Meta (Facebook/Instagram), LinkedIn, Twitter/X ou d'autres plateformes publicitaires. Utiliser aussi quand l'utilisateur mentionne \"PPC\", \"paid media\", \"texte publicitaire\", \"création publicitaire\", \"ROAS\", \"CPA\", \"campagne publicitaire\", \"reciblage\" ou \"ciblage d'audience\". Ce skill couvre la stratégie de campagne, la création d'annonces, le ciblage d'audience et l'optimisation."
license: MIT
metadata:
  version: 1.0.0

...
description: "Rédiger des communications internes d'entreprise — mises à jour 3P (Progrès/Plans/Problèmes), newsletters à l'échelle de l'entreprise, synthèses de FAQ, rapports d'incident, mises à jour de direction, rapports de statut, mises à jour de projet et communications internes générales. Utiliser cette compétence chaque fois que l'utilisateur demande à rédiger, modifier ou formater quelque chose destiné à un public interne. Se déclenche sur des mots-clés comme « 3P », « mise à jour hebdomadaire », « newsletter », « FAQ », « communications internes », « rapport de statut », « mise à jour de l'entreprise », « mise à jour d'équipe », « rapport d'incident », ou toute demande de résumé de travail pour la direction, les coéquipiers ou l'entreprise au sens large. Même des demandes informelles comme « rédige ma mise à jour » ou « résume ce que mon équipe a fait cette semaine » doivent déclencher cette compétence."
---

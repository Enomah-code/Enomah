...
description: "Compétence d'ingénierie des données pour la construction de pipelines de données scalables, de systèmes ETL/ELT et d'infrastructure de données. Expertise en Python, SQL, Spark, Airflow, dbt, Kafka et la stack de données moderne. Inclut la modélisation des données, l'orchestration de pipelines, la qualité des données et le DataOps. À utiliser pour concevoir des architectures de données, construire des pipelines de données, optimiser des workflows de données, implémenter une gouvernance des données ou résoudre des problèmes liés aux données."
---

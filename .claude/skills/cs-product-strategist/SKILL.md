...
description: "Agent de stratégie produit pour la planification OKR trimestrielle, l'analyse du paysage concurrentiel, le développement de vision produit et l'évaluation de pivot stratégique. À utiliser quand la question porte sur la direction plutôt que sur la livraison — par exemple, décliner les OKR de l'entreprise en objectifs d'équipe produit pour le trimestre suivant, ou conduire une analyse concurrentielle approfondie pour décider d'entrer sur un marché adjacent."

...
description: "Génère des runbooks opérationnels à partir du nom d'un service — workflows de déploiement, de réponse aux incidents, de maintenance et de rollback. Structure basée sur des modèles personnalisables par environnement. À utiliser pour documenter les procédures d'astreinte d'un nouveau service, standardiser la réponse aux incidents entre les équipes, ou produire des runbooks avant un passage en production."
---

...
description: "Effectue l'analyse de ratios financiers, la valorisation DCF, l'analyse des écarts budgétaires et les prévisions glissantes. Utilisation : /financial-health <ratios|dcf|budget|forecast> <données.json>"

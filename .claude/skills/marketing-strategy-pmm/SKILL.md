...
description: "Skill de marketing produit pour le positionnement, la stratégie GTM, l'intelligence concurrentielle et les lancements de produits. À utiliser quand l'utilisateur pose des questions sur le positionnement produit, la planification go-to-market, l'analyse concurrentielle, la définition de l'audience cible, la définition d'ICP, l'étude de marché, les plans de lancement ou l'aide à la vente. Couvre le positionnement selon April Dunford, la définition d'ICP, les battlecards concurrentielles, les playbooks de lancement et l'entrée sur les marchés internationaux. Produit des livrables incluant des déclarations de positionnement, des documents battlecard, des plans de lancement et des stratégies go-to-market."
triggers:
  - product marketing
  - PMM
  - positioning

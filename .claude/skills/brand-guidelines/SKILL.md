...
description: "Lorsque l'utilisateur souhaite appliquer, documenter ou faire respecter les directives de marque pour tout produit ou entreprise. À utiliser également lorsque l'utilisateur mentionne 'directives de marque', 'couleurs de marque', 'typographie', 'utilisation du logo', 'voix de marque', 'identité visuelle', 'ton de communication', 'standards de marque', 'guide de style', 'cohérence de marque' ou 'standards de design d'entreprise'. Couvre les systèmes de couleurs, la typographie, les règles de logo, les directives d'image et la matrice de ton pour toute marque — y compris l'identité officielle d'Anthropic."
license: MIT
metadata:
  version: 1.0.0

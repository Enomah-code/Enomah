---
name: "cs-webinar"
description: "/cs:webinar — Flux de travail marketing pour webinaires et événements virtuels. Planifie un webinaire de zéro (dimensionné à rebours depuis l'objectif business), sauve un webinaire aux résultats décevants (analyse du funnel, correction de l'étape défaillante), ou transforme un webinaire passé en moteur de leads evergreen à la demande. Couvre le funnel complet : inscription, calendrier de promotion, présence, engagement en direct, conversion live-to-close, et suivi segmenté. Traite un webinaire comme un funnel, pas comme un événement."
---

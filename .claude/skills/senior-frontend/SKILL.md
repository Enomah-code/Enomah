...
description: "Compétence de développement frontend pour les applications React, Next.js, TypeScript et Tailwind CSS. À utiliser pour construire des composants React, optimiser les performances Next.js, analyser les tailles de bundles, initialiser des projets frontend, implémenter l'accessibilité ou examiner la qualité du code frontend."
---

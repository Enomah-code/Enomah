...
description: "Analyse les bases de code pour détecter la dette technique, évalue la sévérité, suit les tendances et génère des plans de remédiation priorisés. À utiliser quand les utilisateurs mentionnent la dette technique, la qualité du code, la priorité de refactorisation, le scoring de dette, les sprints de nettoyage ou l'évaluation de la santé du code. Également utile pour la planification de modernisation de code legacy et l'estimation des coûts de maintenance."
---

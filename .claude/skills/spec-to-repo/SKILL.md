---
name: spec-to-repo
description: "À utiliser quand l'utilisateur dit « construis-moi une application », « crée un projet à partir de cette spec », « génère un nouveau dépôt », « génère un starter », « transforme cette idée en code », « amorce un projet », « j'ai des exigences et j'ai besoin d'une base de code », ou fournit une spécification de projet en langage naturel et attend un dépôt complet et fonctionnel. Agnostique en termes de stack : Next.js, FastAPI, Rails, Go, Rust, Flutter, et plus encore."
---

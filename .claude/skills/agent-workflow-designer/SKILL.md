...
description: "Concevoir des workflows multi-agents de qualité production avec un choix de schéma clair (séquentiel, parallèle, hiérarchique), des contrats de passation, la gestion des erreurs et des contrôles de coût/contexte. À utiliser lors de l'architecture d'un pipeline d'agents multi-étapes, du choix entre approches mono-agent et multi-agents, ou de la refactorisation d'un workflow LLM souffrant de surcharge de contexte ou de passations peu fiables."
---

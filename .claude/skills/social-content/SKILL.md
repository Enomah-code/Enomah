---
name: "social-content"
description: "Quand l'utilisateur souhaite de l'aide pour créer, planifier ou optimiser du contenu sur les réseaux sociaux pour LinkedIn, Twitter/X, Instagram, TikTok, Facebook ou d'autres plateformes. À utiliser aussi quand l'utilisateur mentionne « publication LinkedIn », « thread Twitter », « réseaux sociaux », « calendrier éditorial », « planification sociale », « engagement » ou « contenu viral ». Ce skill couvre la création de contenu, le recyclage et les stratégies spécifiques à chaque plateforme."
license: MIT
metadata:
  version: 1.0.0

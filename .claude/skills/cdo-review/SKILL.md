---
name: "cdo-review"
description: "/cs:cdo-review <plan> — Interrogation de Chief Data Officer axée sur la décision de tout plan touchant aux données d'entraînement, à l'architecture des données, à la productisation des données, ou au recrutement de l'équipe data. À utiliser lors de la validation des droits sur les données d'entraînement avant un travail de modélisation, du choix entre entrepôt de données, data lake ou data mesh, ou de l'évaluation des actifs data pour la productisation ou les fusions-acquisitions."
---

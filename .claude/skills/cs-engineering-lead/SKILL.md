...
description: "Agent Tech Lead d'équipe ingénierie pour coordonner les équipes QA, sécurité, data engineering, ML et frontend/backend. Orchestre les skills d'équipes ingénierie pour les décisions techniques au niveau équipe. À invoquer lorsque les utilisateurs ont besoin de coordination d'équipe, d'évaluation de stack technique, de réponse à incident ou de travail d'ingénierie transverse."

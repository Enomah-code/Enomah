---
name: "cpo-review"
description: "/cs:cpo-review <plan> — Interrogation de la roadmap produit, des signaux PMF et du focus portefeuille selon l'approche JTBD. À utiliser lors de la validation de la roadmap d'un trimestre, de la décision d'abandonner une fonctionnalité, ou lorsqu'on revendique un PMF sans courbe de rétention."
---

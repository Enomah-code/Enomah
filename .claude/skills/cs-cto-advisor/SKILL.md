---
name: cs-cto-advisor
description: "Conseiller en leadership technique pour les CTO couvrant la stratégie technologique, la montée en charge des équipes, les décisions d'architecture et l'excellence ingénierie. À utiliser lorsqu'un CTO ou fondateur technique a besoin d'un jugement technologique au niveau de l'entreprise — par exemple, décider de construire ou d'acheter un composant de plateforme central, ou planifier comment faire passer l'organisation ingénierie de 5 à 30 ingénieurs sans perdre en vélocité de livraison."

---
name: deal-desk
description: "À utiliser lors de l'examen d'un deal entrant spécifique avant sa clôture — quand les ventes ont demandé une remise dépassant l'autorité de l'AE, quand le client a modifié le MSA, quand les économies par deal (marge après remise, structure de paiement pluriannuelle, exposition aux indemnités) doivent être quantifiées, ou quand l'approbation de remise doit être acheminée vers un approbateur humain nommé (Directeur Commercial, VP Ventes, CFO, CRO, Conseiller Juridique). Couvre la revue de deal, le routage d'approbation de remise, le scoring de marge par deal, la gestion des exceptions de deal, le tri des modifications MSA, la détection des clauses contractuelles à risque (indemnité non plafonnée, MFN, licence perpétuelle, DPA manquant), et l'assemblage de la chaîne d'approbateurs nommés. N'approuve JAMAIS automatiquement — chaque sortie est un tableau de bord numérique avec une recommandation de routage vers un humain nommé."
version: 2.8.0

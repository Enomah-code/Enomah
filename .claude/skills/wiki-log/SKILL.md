---
name: wiki-log
description: "Affiche les entrées récentes du journal du Wiki LLM (wiki/log.md). Utilise le format d'en-tête standardisé ## [AAAA-MM-JJ] pour que grep + tail fonctionnent. Usage : /wiki-log [--last N] [--op ingest|query|lint|...]"
---

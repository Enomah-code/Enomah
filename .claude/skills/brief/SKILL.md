---
name: "brief"
description: "/cs:brief <sujet> — Génère un brief stratégique d'une page à partir d'un entretien office hours. Première étape dans le pipeline de sprint stratégique. À utiliser lorsqu'une question stratégique doit être cadrée avant la délibération en salle du conseil — par ex. verrouiller les options, hypothèses et critères de succès pour un changement de tarification ou une décision d'entrée sur le marché."
---

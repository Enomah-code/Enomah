---
name: "office-hours"
description: "/cs:office-hours <sujet> — Interrogatoire fondateur en 6 questions style YC avant tout conseil. Force la clarté sur le problème, le client, la distribution, la défendabilité, le capital et l'adéquation fondateur. À utiliser quand une question de fondateur est trop vague pour être routée — ex. 'devrions-nous croître plus vite ?' — ou avant de rédiger un brief stratégique."
---

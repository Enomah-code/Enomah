...
description: "Quand l'utilisateur a besoin d'idées marketing, d'inspiration ou de stratégies pour son produit SaaS ou logiciel. À utiliser aussi quand l'utilisateur demande 'idées marketing', 'idées de croissance', 'comment commercialiser', 'stratégies marketing', 'tactiques marketing', 'moyens de promotion', ou 'idées pour croître'. Ce skill fournit 139 approches marketing éprouvées organisées par catégorie."
license: MIT
metadata:
  version: 1.0.0

---
name: "status"
description: "Tableau de bord de santé mémoire affichant le nombre de lignes, les fichiers de sujets, la capacité, les entrées obsolètes et des recommandations. À utiliser lorsque l'utilisateur exécute /si:status ou demande l'état ou la capacité de la mémoire de l'agent."
---

---
name: "ai-security"
description: "À utiliser pour évaluer les systèmes IA/ML concernant l'injection de prompts, les vulnérabilités de contournement, le risque d'inversion de modèle, l'exposition à l'empoisonnement des données ou l'abus d'outils d'agents. Couvre la cartographie des techniques MITRE ATLAS, la détection de signatures d'injection et le score de robustesse adversariale."
---

---
name: "ciso-advisor"
description: "Leadership en sécurité pour les entreprises en phase de croissance. Quantification des risques en termes financiers, feuille de route de conformité (SOC 2/ISO 27001/HIPAA/RGPD), stratégie d'architecture de sécurité, pilotage de la réponse aux incidents et reporting sécurité au niveau du conseil d'administration. À utiliser pour construire des programmes de sécurité, justifier un budget sécurité, sélectionner des référentiels de conformité, gérer des incidents, évaluer les risques fournisseurs, ou lorsque l'utilisateur mentionne CISO, stratégie de sécurité, feuille de route de conformité, zero trust ou reporting sécurité au conseil."
license: MIT
metadata:
  version: 1.0.0

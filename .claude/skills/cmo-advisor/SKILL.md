---
name: "cmo-advisor"
description: "Leadership marketing pour les entreprises en croissance. Positionnement de marque, conception du modèle de croissance, allocation du budget marketing et conception de l'organisation marketing. À utiliser lors de la conception d'une stratégie de marque, de la sélection de modèles de croissance (PLG vs axé sur les ventes vs axé sur la communauté), de l'allocation des budgets marketing, de la constitution d'équipes marketing, ou lorsque l'utilisateur mentionne CMO, stratégie de marque, modèle de croissance, CAC, LTV, mix de canaux ou ROI marketing."
license: MIT
metadata:
  version: 1.0.0

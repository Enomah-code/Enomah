...
description: "Profilage de performance systématique pour les applications Node.js, Python et Go. Identifie les goulots d'étranglement CPU, mémoire et I/O, génère des flamegraphs, analyse les tailles de bundles, optimise les requêtes de base de données, exécute des tests de charge avec k6 et Artillery. Mesure toujours avant et après. Utiliser lors de l'investigation d'un endpoint lent, de la planification d'un budget de performance ou de la recherche d'une fuite mémoire en production."
---

...
description: "Analyse les produits et entreprises concurrents en synthétisant des données provenant des pages de tarification, des avis d'app stores, des offres d'emploi, des signaux SEO et des réseaux sociaux en intelligence concurrentielle structurée. Produit des matrices de comparaison de fonctionnalités notées sur 12 dimensions, des analyses SWOT, des cartes de positionnement, des audits UX, des décompositions de modèles de tarification, des feuilles de route d'actions et des modèles de présentation pour parties prenantes. À utiliser lors d'une analyse concurrentielle, de la comparaison de produits face aux concurrents, de la recherche du paysage concurrentiel, de la construction de battlecards pour les ventes, de la préparation d'une session de stratégie produit ou de feuille de route, de la réponse à une nouvelle fonctionnalité ou changement de tarification d'un concurrent, ou d'une revue concurrentielle trimestrielle."
---

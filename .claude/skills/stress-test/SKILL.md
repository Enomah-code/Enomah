---
name: "stress-test"
description: "/em:stress-test — Test de résistance des hypothèses métier. À utiliser avant de parier sur un plan dont les hypothèses fondamentales ne sont pas validées — par exemple, tester la résistance de l'hypothèse « les acheteurs entreprise tolèreront un pilote de 6 mois » ou d'un modèle de revenus en croissance exponentielle."
---

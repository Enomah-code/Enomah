...
description: "Agent de gestion produit pour la priorisation de fonctionnalités, la découverte client, le développement de PRD et la planification de roadmap selon le framework RICE. À utiliser quand une décision produit nécessite structure et preuves — par exemple, scorer avec RICE un backlog de 20 demandes de fonctionnalités avant la planification trimestrielle, ou rédiger un PRD à partir de notes brutes d'entretiens clients."

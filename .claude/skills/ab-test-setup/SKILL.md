---
name: "ab-test-setup"
description: "Quand l'utilisateur souhaite planifier, concevoir ou implémenter un test A/B ou une expérimentation. À utiliser également quand l'utilisateur mentionne « test A/B », « split test », « expérimentation », « tester ce changement », « variante de texte », « test multivarié », « hypothèse », « expérience de conversion », « significativité statistique » ou « tester ceci ». Pour l'implémentation du suivi, voir analytics-tracking."
license: MIT
metadata:
  version: 1.0.0

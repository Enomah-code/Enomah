...
description: "Quand l'utilisateur veut planifier, promouvoir, animer ou améliorer un webinaire ou événement virtuel pour générer et convertir de la demande. À utiliser quand l'utilisateur mentionne 'webinaire', 'événement virtuel', 'événement en ligne', 'démonstration en direct', 'sommet virtuel', 'atelier', 'masterclass', 'conversation informelle', 'table ronde', 'entonnoir d'inscription', 'taux de présence', 'taux d'assistance', 'promotion de webinaire', 'suivi de webinaire' ou 'webinaire à la demande'. À utiliser aussi quand ils ont un webinaire qui ne convertit pas — peu d'inscriptions, faible présence, ou participants qui n'achètent pas — et souhaitent diagnostiquer et corriger le problème. Couvre l'entonnoir complet : inscription, promotion, présence, engagement en direct, conversion en direct, et nurturing post-événement. Distinct de launch-strategy (lancements complets de produits) et email-sequence (nurturing cycle de vie) — c'est le flux end-to-end webinaire/événement. PAS pour la logistique d'événements terrain en présentiel, et PAS pour les emails de cycle de vie génériques (utiliser email-sequence)."
license: MIT
metadata:
  version: 1.0.0

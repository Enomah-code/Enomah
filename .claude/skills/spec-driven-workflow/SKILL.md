...
description: "À utiliser quand l'utilisateur souhaite écrire des spécifications avant le code, définir des critères d'acceptation, planifier des fonctionnalités avant l'implémentation, générer des tests à partir de spécifications, ou suivre des pratiques de développement spec-first."
---

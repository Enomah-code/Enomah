...
description: "À utiliser pour écrire du SQL Snowflake, construire des pipelines de données avec des Tables Dynamiques ou des Streams/Tasks, utiliser les fonctions Cortex AI, créer des Agents Cortex, écrire du Snowpark Python, configurer dbt pour Snowflake, ou résoudre des erreurs Snowflake."
---

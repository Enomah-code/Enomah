...
description: "Agent d'analyse produit pour la définition de KPI, la mise en place de tableaux de bord, la conception d'expériences et l'interprétation des résultats de tests. À utiliser quand une question produit nécessite des chiffres — par exemple, définir des KPI d'activation/rétention et une spec de tableau de bord pour une nouvelle fonctionnalité, ou calibrer un test A/B et évaluer si le résultat est suffisamment significatif pour livrer."
skills:

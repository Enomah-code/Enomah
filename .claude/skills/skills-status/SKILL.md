---
name: "status"
description: "Affiche l'état du DAG, la progression des agents et le statut des branches pour une session AgentHub. À utiliser lorsque l'utilisateur exécute /hub:status ou demande comment se portent les agents AgentHub."
command: /hub:status
---

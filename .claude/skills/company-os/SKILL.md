---
name: "company-os"
description: "Le méta-cadre de fonctionnement d'une entreprise — le tissu conjonctif entre tous les rôles de la direction générale. Couvre la sélection du système d'exploitation (EOS, Scaling Up, OKR-natif, hybride), les organigrammes de responsabilité, les tableaux de bord, la cadence des réunions, la résolution des problèmes et les objectifs à 90 jours. À utiliser lors de la mise en place des opérations d'entreprise, de la sélection d'un cadre de gestion, de la conception des rythmes de réunion, de la construction de systèmes de responsabilité, de la mise en œuvre des OKR, ou lorsque l'utilisateur mentionne EOS, Scaling Up, système d'exploitation, réunions L10, rocks, tableau de bord, organigramme de responsabilité ou planification trimestrielle."
license: MIT
metadata:
  version: 1.0.0

...
description: "À utiliser lorsque l'utilisateur souhaite planifier le lancement d'un produit, l'annonce d'une fonctionnalité ou une stratégie de mise sur le marché. À utiliser également lorsque l'utilisateur mentionne « lancement », « Product Hunt », « sortie de fonctionnalité », « annonce », « go-to-market », « lancement bêta », « accès anticipé », « liste d'attente », « mise à jour produit », « plan GTM », « checklist de lancement » ou « dynamique de lancement ». Ce skill couvre les lancements par phases, la stratégie de canaux et la dynamique de lancement continue."
license: MIT
metadata:
  version: 1.0.0

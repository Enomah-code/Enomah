...
description: "Spécialiste en Système de Management de l'Intelligence Artificielle (SMAI) ISO/IEC 42001:2023 pour les équipes de conformité conduisant des audits internes. Trois décisions clés : (1) Où se situent les écarts par rapport aux Clauses 4 à 10 et que faut-il combler en priorité ? (2) Que faut-il inscrire dans le registre des risques IA et quels contrôles de l'Annexe A traitent chaque risque ? (3) Quel est le plan d'audit interne sur 12 mois satisfaisant la Clause 9.2 ? À utiliser lors de la préparation à la certification, du cadrage des cycles d'audit interne, ou de l'intégration de systèmes IA dans un programme SMSI (27001) / QMS (13485) existant. N'est PAS un skill de stratégie IA pour dirigeants (voir chief-ai-officer-advisor). N'est PAS dédié à la conformité EU AI Act (voir compliance-team-eu-ai-act)."
license: MIT
metadata:
  version: 1.0.0

...
description: "Répertoire et routeur pour la bibliothèque de skills marketing. À utiliser quand vous avez besoin de trouver le bon skill marketing pour une tâche, de voir quelles capacités marketing existent, ou de vous orienter dans ce plugin. 44 skills spécialisés répartis en 8 pods (contenu, SEO + AEO, CRO, canaux, croissance, intelligence, aide à la vente, ops), 59 outils Python stdlib. Redirige vers un seul skill — il n'exécute pas lui-même le travail marketing."
version: 2.10.3

---
name: "cto-advisor"
description: "Guidance en leadership technique pour les équipes d'ingénierie, les décisions d'architecture et la stratégie technologique. À utiliser pour évaluer la dette technique, faire évoluer les équipes d'ingénierie, évaluer des technologies, prendre des décisions d'architecture, établir des métriques d'ingénierie, ou quand l'utilisateur mentionne CTO, dette tech, dette technique, montée en charge des équipes, décisions d'architecture, évaluation technologique, métriques d'ingénierie, métriques DORA, ou stratégie technologique."
license: MIT
metadata:
  version: 2.0.0

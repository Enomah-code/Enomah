...
description: "À utiliser lorsque l'utilisateur souhaite automatiser des tâches de navigation web, scraper des sites, remplir des formulaires, capturer des captures d'écran, extraire des données structurées depuis des pages web ou construire des workflows d'automatisation web. PAS pour les tests — utiliser playwright-pro pour cela."
---

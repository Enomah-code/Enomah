---
name: tdd
description: "Exécute un workflow TDD rouge-vert-refactorisation — génère d'abord des tests en échec, implémente jusqu'au vert, puis vérifie les lacunes de couverture. Utilisation : /tdd <generate|coverage|validate> [cible]"

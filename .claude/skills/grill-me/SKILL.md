---
name: grill-me
description: "Interroge l'utilisateur sans relâche sur un plan ou une conception jusqu'à atteindre une compréhension commune, en résolvant chaque branche de l'arbre de décision. Utiliser lorsque l'utilisateur souhaite tester un plan sous pression, se faire questionner sur sa conception, ou mentionne « grill me »."
license: MIT
metadata:

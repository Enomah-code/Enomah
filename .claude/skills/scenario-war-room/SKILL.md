...
description: "Modélisation what-if interfonctionnelle pour des scénarios multi-variables en cascade. Contrairement aux tests de résistance à hypothèse unique, cet outil modélise l'adversité composée sur toutes les fonctions métier simultanément. À utiliser face à des scénarios de risque complexes, des décisions stratégiques à fort potentiel de perte, ou quand l'utilisateur demande 'que se passe-t-il si X ET Y surviennent en même temps ?'"
license: MIT
metadata:
  version: 1.0.0

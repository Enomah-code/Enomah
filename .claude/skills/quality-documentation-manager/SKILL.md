...
description: "Gestion du système de maîtrise des documents pour les SMQ de dispositifs médicaux. Couvre la numérotation des documents, la gestion des versions, la gestion des modifications et la conformité 21 CFR Part 11. À utiliser pour travailler sur les procédures de maîtrise des documents, les flux de gestion des modifications, la numérotation des documents, la gestion des versions, la conformité des signatures électroniques ou la revue de la documentation réglementaire."
triggers:
  - document control
  - document numbering
  - version control

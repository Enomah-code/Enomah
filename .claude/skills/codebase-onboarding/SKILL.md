...
description: "Analyse une base de code et génère de la documentation d'intégration pour les ingénieurs, tech leads et prestataires. Collecte rapide d'informations et production répétable de livrables d'intégration. À utiliser lors de l'intégration d'un nouvel ingénieur, de la rédaction de documentation de vue d'ensemble architecturale pour un nouveau projet, ou de la production de briefings pour tech leads sur des dépôts inconnus."
---

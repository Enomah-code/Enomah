...
description: "Passe en revue les modifications git en staging selon les 4 principes de codage de Karpathy. Exécute complexity_checker sur les fichiers modifiés, diff_surgeon sur le diff, et produit un verdict avec des recommandations de corrections précises. À invoquer avant de committer, quand l'utilisateur dit « karpathy check », « review my diff », ou lorsque la commande /karpathy-check est invoquée."

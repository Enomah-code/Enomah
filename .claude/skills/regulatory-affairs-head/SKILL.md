...
description: "Responsable Affaires Réglementaires Senior pour les entreprises HealthTech et MedTech. Prépare les dossiers de soumission FDA 510(k), De Novo et PMA ; analyse les voies réglementaires pour les nouveaux dispositifs médicaux ; rédige les réponses aux lettres de carence FDA et aux questions des organismes notifiés ; développe la documentation technique du marquage CE dans le cadre de l'EU MDR 2017/745 ; coordonne les stratégies d'approbation multi-marchés (FDA, UE, Santé Canada, PMDA, NMPA) ; et assure une veille réglementaire sur l'évolution des normes. À utiliser lorsque les utilisateurs ont besoin de planifier ou d'exécuter des soumissions FDA, naviguer dans les processus d'approbation 510(k) ou PMA, obtenir le marquage CE, préparer des réunions de pré-soumission, rédiger des documents de stratégie réglementaire, répondre aux demandes des agences ou gérer la documentation de conformité pour l'accès au marché des dispositifs médicaux."
triggers:
  - regulatory strategy
  - FDA submission
  - EU MDR

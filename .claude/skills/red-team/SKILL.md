---
name: "red-team"
description: "À utiliser pour planifier ou exécuter des engagements de red team autorisés, des analyses de chemins d'attaque ou des simulations de sécurité offensive. Couvre la planification de la kill-chain MITRE ATT&CK, le scoring des techniques, l'identification des points d'étranglement, l'évaluation des risques OPSEC et le ciblage des actifs critiques (crown jewels)."
---

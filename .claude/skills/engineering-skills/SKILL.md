...
description: "Index du bundle de skills d'équipe d'ingénierie pour Claude Code, Codex, Gemini CLI, Cursor, OpenClaw et 6 autres outils. Architecture, frontend, backend, QA, DevOps, sécurité, IA/ML, ingénierie des données, Playwright, Stripe, AWS, MS365 (outils Python stdlib uniquement). À utiliser pour parcourir ou choisir parmi les skills de rôle d'équipe d'ingénierie — chargez uniquement le SKILL.md spécialiste dont vous avez besoin, ne chargez jamais le bundle en bloc."
version: 2.9.0

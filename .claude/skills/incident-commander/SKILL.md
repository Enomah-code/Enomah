...
description: "Cadre complet de réponse aux incidents, de la détection à la résolution et à la revue post-incident. Pratiques SRE/DevOps éprouvées : classification de la sévérité, reconstruction de la chronologie, analyse structurée post-incident. Utiliser lors de la déclaration d'un incident, de la coordination d'une réponse multi-équipes lors d'une panne, de la direction d'un post-mortem, ou de la mise en place de pratiques d'astreinte pour un nouveau service."
---

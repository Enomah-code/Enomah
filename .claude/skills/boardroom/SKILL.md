---
name: "boardroom"
description: "/cs:boardroom <brief> — Délibération multi-rôles en 6 phases à travers la direction avec isolation de la Phase 2, pré-filtrage critique et synthèse. Produit un mémo de conseil. À utiliser lorsqu'une décision couvre plusieurs domaines exécutifs — par ex. un changement de tarification touchant la finance, le positionnement et le produit, ou un arbitrage allonger-la-piste-vs-réduire-les-coûts."
---

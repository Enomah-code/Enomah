...
description: "Exécute des tests d'hypothèses, analyse les résultats d'expériences A/B, calcule les tailles d'échantillon et interprète la significativité statistique avec les tailles d'effet. À utiliser lorsque vous devez valider si des différences observées sont réelles, dimensionner correctement une expérience avant son lancement, ou interpréter des résultats de tests avec confiance."
---

...
description: "Session d'interrogation ancrée dans la documentation — confronte un plan au langage existant du projet (CONTEXT.md) et aux décisions enregistrées (docs/adr/), et met à jour ces fichiers en ligne à mesure que la terminologie et les décisions se cristallisent. Utiliser lorsque l'utilisateur souhaite tester un plan face au langage de domaine documenté, ou mentionne « grill with docs »."
license: MIT
metadata:

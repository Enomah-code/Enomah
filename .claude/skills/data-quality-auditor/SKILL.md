...
description: "Audite des jeux de données pour leur complétude, cohérence, exactitude et validité. Profite les distributions de données, détecte les anomalies et valeurs aberrantes, remonte les problèmes structurels, et produit un plan de remédiation actionnable. À utiliser quand l'utilisateur demande à vérifier la qualité des données, profiler un jeu de données, traquer les valeurs aberrantes ou manquantes, ou valider des données avant analyse ou entraînement de modèle."
---

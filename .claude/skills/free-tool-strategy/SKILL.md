...
description: "À utiliser quand l'utilisateur souhaite créer un outil gratuit à des fins marketing — génération de leads, valeur SEO ou notoriété de marque. À utiliser quand il mentionne 'l'ingénierie comme marketing', 'outil gratuit', 'calculateur', 'générateur', 'vérificateur', 'évaluateur', 'outil marketing', 'outil de génération de leads', 'construire quelque chose pour le trafic', 'outil interactif' ou 'ressource gratuite'. Couvre l'évaluation des idées, la conception de l'outil et la stratégie de lancement. Pour une stratégie de contenu SEO pur (sans outil), utilisez seo-audit ou content-strategy à la place."
license: MIT
metadata:
  version: 1.0.0

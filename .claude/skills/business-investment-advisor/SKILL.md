...
description: "Conseiller en analyse d'investissement et allocation de capital. À utiliser pour évaluer s'il faut investir dans des équipements, de l'immobilier, une nouvelle activité, des recrutements, de la technologie ou toute dépense en capital. Également pour les calculs de ROI, TRI, VAN, délai de remboursement, décisions construire-vs-acheter, analyse location-vs-achat, évaluation de fournisseurs ou pour décider où allouer un budget limité pour un rendement maximal."
---

---
name: "cco-review"
description: "/cs:cco-review <plan> — Interrogation de Chief Customer Officer obsédé par la rétention de tout plan touchant à la rétention client, la segmentation, le dimensionnement de l'équipe CS, ou le recrutement CS. À utiliser lorsque la rétention brute se dégrade, avant d'approuver des effectifs CSM, ou lors de la décision des segments clients à conserver ou à abandonner."
---

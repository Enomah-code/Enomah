...
description: "Administrateur Atlassian pour gérer et organiser les produits Atlassian (Jira, Confluence, Bitbucket, Trello), les utilisateurs, les permissions, la sécurité, les intégrations, la configuration système et la gouvernance à l'échelle de l'organisation. À utiliser pour ajouter des utilisateurs à Jira, modifier les permissions Confluence, configurer le contrôle d'accès, mettre à jour les paramètres administrateur, gérer les groupes Atlassian, configurer le SSO, installer des applications marketplace, réviser les politiques de sécurité ou gérer toute tâche d'administration Atlassian à l'échelle de l'organisation."
---

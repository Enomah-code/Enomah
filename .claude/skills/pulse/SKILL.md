---
name: pulse
description: "Skill de veille multi-sources qui prend le pouls d'un sujet sur Reddit, Hacker News, le web ouvert, et optionnellement X/Twitter sur une fenêtre temporelle configurable (30 jours par défaut). Une phase de collecte d'informations clarifie la spécificité du sujet, l'angle (tendance/sentiment/problèmes/opportunités/comparaison), la fenêtre temporelle et la portée des plateformes avant la recherche. Retourne un briefing synthétisé avec citations, métriques d'engagement et analyse des tendances inter-plateformes. À utiliser lorsque l'utilisateur demande une veille multi-sources sur un sujet (ex. : 'pouls sur [sujet]', 'qu'est-ce qui se passe avec [sujet]', 'que disent les gens sur [sujet]', 'conversation actuelle sur [sujet]', 'tendance : [sujet]', 'trouve-moi des infos sur [sujet]'), ainsi que pour la recherche concurrentielle, la découverte de tendances, les comparaisons d'outils et l'analyse du sentiment des audiences."
license: MIT
metadata:

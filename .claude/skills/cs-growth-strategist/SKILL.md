...
description: "Agent Stratège de Croissance pour les opérations commerciales, l'ingénierie des ventes, le succès client et le développement des affaires. Orchestre les compétences de croissance commerciale. À invoquer quand les utilisateurs ont besoin d'analyse de pipeline, de prévention du churn, de scoring d'expansion, de démos commerciales ou de rédaction de propositions."

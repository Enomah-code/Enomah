...
description: "Produit des notes de version cohérentes et auditables à partir des Commits Conventionnels. Sépare l'analyse des commits, la logique de version sémantique et le rendu du changelog pour des releases automatisées avec contrôle éditorial. À utiliser lors de la publication d'une release, de la génération de CHANGELOG.md à partir de l'historique git, du calcul de la prochaine version sémantique à partir des commits, de l'automatisation des notes de release en CI, ou de la planification d'un hotfix/rollback. Exemples : 'générer le changelog pour v1.4.0', 'quel bump de version ces commits requièrent-ils', 'nous avons besoin d'un processus de hotfix d'urgence'."
---

...
description: "/cs:compliance-readiness <programme> — Responsable de la conformité multi-référentiels : interrogation forcée en 6 questions de tout programme de conformité. Utiliser avant de démarrer un nouveau référentiel, de planifier le calendrier d'audit annuel, ou de se préparer à l'étape 1 de certification."
---

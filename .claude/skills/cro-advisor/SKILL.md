---
name: "cro-advisor"
description: "Leadership des revenus pour les entreprises SaaS B2B. Prévision des revenus, conception du modèle de vente, stratégie de tarification, rétention nette des revenus et montée en charge des équipes commerciales. À utiliser lors de la conception du moteur de revenus, de la fixation des quotas, de la modélisation du NRR, de l'évaluation de la tarification, de la construction des prévisions pour le conseil, ou lorsque l'utilisateur mentionne CRO, directeur des revenus, stratégie de revenus, modèle de vente, croissance ARR, NRR, revenus d'expansion, churn, stratégie de tarification ou capacité commerciale."
license: MIT
metadata:
  version: 1.0.0

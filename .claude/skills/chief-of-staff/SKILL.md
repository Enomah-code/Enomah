---
name: "chief-of-staff"
description: "Couche d'orchestration C-suite. Oriente les questions des fondateurs vers le(s) bon(s) rôle(s) de conseil, déclenche des réunions de conseil multi-rôles pour les décisions complexes, synthétise les résultats et assure le suivi des décisions. Chaque interaction C-suite commence ici. Charge automatiquement le contexte de l'entreprise. À utiliser lorsqu'une question de fondateur nécessite d'être orientée vers le bon conseiller — ex. 'devrions-nous lever des fonds maintenant ou réduire le burn ?' — ou lorsqu'une décision multi-domaine nécessite la convocation d'une réunion de conseil."
license: MIT
metadata:
  version: 1.0.0

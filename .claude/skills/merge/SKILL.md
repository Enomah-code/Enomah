---
name: "merge"
description: "Fusionne la branche de l'agent gagnant dans la base, archive les perdants et nettoie les worktrees. À utiliser quand l'utilisateur exécute /hub:merge ou demande à atterrir le résultat AgentHub gagnant et à ranger la session."
command: /hub:merge
---

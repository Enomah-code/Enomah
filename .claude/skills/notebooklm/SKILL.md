---
name: notebooklm
description: "Compétence d'automatisation navigateur pour contrôler NotebookLM de Google. À utiliser quand l'utilisateur veut effectuer quoi que ce soit dans NotebookLM (ex. : 'ouvrir NotebookLM', 'consulter mon carnet [nom]', 'interroger mon carnet sur X', 'ajouter [source] à NotebookLM', 'générer un aperçu vidéo depuis mon carnet', 'utiliser NotebookLM Studio'). Gère la lecture et l'interrogation des carnets, l'ajout de sources (URLs, texte, fichiers, liens YouTube, contenu synthétisé), la génération de sorties Studio (Aperçus Audio/Vidéo, Cartes mentales, Rapports incluant Briefing Doc/Guide d'étude/FAQ, Flashcards, Quiz, présentations, infographies — découvrir l'ensemble exact depuis le panneau Studio en direct ; l'interface évolue rapidement), et la création de nouveaux carnets. Nécessite un environnement d'automatisation navigateur — échoue gracieusement si indisponible."
license: MIT
metadata:

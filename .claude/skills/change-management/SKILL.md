...
description: "Cadre pour déployer des changements organisationnels sans chaos. Couvre le modèle ADKAR adapté aux startups, les modèles de communication, les schémas de résistance et la gestion de la fatigue au changement. Traite les changements de processus, les restructurations organisationnelles, les pivots stratégiques et les changements culturels. À utiliser lors de l'annonce d'une réorganisation, du changement d'outils, d'un pivot stratégique, de l'abandon d'un produit, d'un changement de leadership, ou lorsque l'utilisateur mentionne gestion du changement, déploiement de changement, gestion de la résistance, changement organisationnel, réorg ou communication de pivot."
license: MIT
metadata:
  version: 1.0.0

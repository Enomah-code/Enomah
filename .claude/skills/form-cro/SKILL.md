---
name: "form-cro"
description: "À utiliser lorsque l'utilisateur souhaite optimiser un formulaire qui N'EST PAS un formulaire d'inscription/enregistrement — y compris les formulaires de capture de leads, de contact, de demande de démo, de candidature, de sondage ou de paiement. À utiliser également lorsque l'utilisateur mentionne « optimisation de formulaire », « conversions de formulaire lead », « friction de formulaire », « champs de formulaire », « taux de complétion de formulaire » ou « formulaire de contact ». Pour les formulaires d'inscription/enregistrement, voir signup-flow-cro. Pour les popups contenant des formulaires, voir popup-cro."
license: MIT
metadata:
  version: 1.0.0

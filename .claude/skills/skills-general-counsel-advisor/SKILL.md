...
description: "Conseil de Directeur Juridique pour startups : révision de contrats (MSA, SaaS, NDA, DPA, emploi), stratégie de propriété intellectuelle, décodage de term sheets et cartographie du paysage réglementaire. À utiliser lors de la révision d'un contrat ou d'un term sheet, du choix du moment d'engager un conseil externe, de la définition d'une stratégie PI, de l'évaluation de l'exposition réglementaire (HIPAA, RGPD, FDA, fintech), ou lorsque l'utilisateur mentionne general counsel, GC, révision juridique, risque contractuel, term sheet, cession de PI ou exposition réglementaire. PAS un substitut à un conseil juridique agréé — met en évidence les questions à soumettre à des avocats qualifiés."
license: MIT
metadata:
  version: 1.0.0

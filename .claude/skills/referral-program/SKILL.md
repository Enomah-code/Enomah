...
description: "Lorsque l'utilisateur souhaite concevoir, lancer ou optimiser un programme de parrainage ou d'affiliation. À utiliser lorsqu'il mentionne 'programme de parrainage', 'programme d'affiliation', 'bouche-à-oreille', 'parrainer un ami', 'programme d'incitation', 'parrainages clients', 'ambassadeur de marque', 'programme partenaire', 'lien de parrainage' ou 'croissance par le parrainage'. Couvre les mécaniques du programme, la conception des incitations et l'optimisation — pas seulement le concept de parrainage, mais le système concret."
license: MIT
metadata:
  version: 1.0.0

...
description: "Spécialiste du Système de Management de l'IA ISO/IEC 42001:2023 (AIMS) pour les équipes conformité menant des audits internes. Trois décisions : (1) Quels sont les écarts par rapport aux Clauses 4-10 et lesquels fermer en premier ? (2) Que contient le registre des risques IA et quels contrôles de l'Annexe A traitent chaque risque ? (3) Quel est le plan d'audit interne sur 12 mois satisfaisant la Clause 9.2 ? À utiliser lors de la préparation à la certification, du cadrage des cycles d'audit interne, ou de l'intégration de systèmes IA dans un SMSI (27001) / SMQ (13485) existant. PAS un skill de stratégie IA exécutive (voir chief-ai-officer-advisor). PAS une conformité à l'AI Act européen (voir compliance-team-eu-ai-act)."
license: MIT
metadata:
  version: 1.0.0

---
name: "hard-call"
description: "/em:hard-call — Cadre pour les décisions sans bonne option. Utiliser lorsque chaque option est douloureuse et qu'une analyse structurée 10/10/10 + minimisation des regrets est nécessaire — par exemple, choisir entre un licenciement et un tour de table à la baisse, ou abandonner une ligne de produit appréciée."
---

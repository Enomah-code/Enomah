---
name: "senior-devops"
description: "Compétence DevOps complète couvrant CI/CD, automatisation d'infrastructure, conteneurisation et plateformes cloud (AWS, GCP, Azure). Inclut la configuration de pipelines, l'infrastructure en tant que code, l'automatisation des déploiements et la supervision. À utiliser pour configurer des pipelines, déployer des applications, gérer l'infrastructure, mettre en place la supervision ou optimiser les processus de déploiement."
---

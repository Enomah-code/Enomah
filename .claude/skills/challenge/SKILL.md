---
name: "challenge"
description: "Analyse pré-mortem d'un plan. Imaginer que le plan a échoué 12 mois plus tard et remonter le fil pour identifier les faiblesses. Met en évidence les hypothèses, les dépendances et les risques d'exécution avant d'engager des ressources. À utiliser avant un engagement de ressources significatif, avant une présentation au conseil ou aux investisseurs, lorsque les retours ont été unanimement positifs, ou lorsqu'il y a une pression pour avancer vite et trouver des solutions plus tard."
---

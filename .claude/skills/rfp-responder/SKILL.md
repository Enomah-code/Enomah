---
name: rfp-responder
description: "À utiliser lorsqu'un RFP, RFI, RFQ, questionnaire de sécurité, questionnaire fournisseur ou demande de proposition arrive et que l'équipe a besoin d'une réponse structurée — analyse des exigences multi-sections dictées par l'acheteur (OBLIGATOIRES vs PONDÉRÉES vs SOUHAITABLES), construction d'une matrice de preuves selon la méthode Shipley associant chaque exigence à un point de preuve vérifiable, articulation de 3 à 5 thèmes gagnants couvrant l'ensemble des exigences, et production d'une estimation de taux de succès dérivée de Shipley qui éclaire une recommandation soumission / non-soumission / soumission en partenariat. Destiné aux Bid Managers, Responsables de propositions, Directeurs commerciaux et Ingénieurs commerciaux au moment de la stratégie de réponse. Expose explicitement les exigences GAP — n'invente jamais de prétentions. Ne couvre pas la rédaction narrative libre de propositions, la révision de contrats ni les supports marketing."
context: fork
version: 2.8.0

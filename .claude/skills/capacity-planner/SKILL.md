...
description: "À utiliser lorsqu'un responsable opérationnel (Directeur CX, Responsable Support, VP Ops, Responsable BizOps, Responsable IT ops, Responsable Finance ops) dimensionne les capacités opérationnelles, élabore un plan d'effectifs, modélise les risques d'utilisation, planifie la capacité Q3 ou la capacité support annuelle, ou conçoit la couverture CS — et a besoin des calculs de file d'attente Erlang-C, du dimensionnement de la demande P90, des ETP ajustés au taux d'absentéisme, des seuils de déclenchement manager, et d'une séquence de recrutement trimestrielle avec rampe et attrition. À appliquer lorsque l'utilisation soutenue de l'équipe dépasse 80% ou lorsque l'équipe croît de plus de 50% en 12 mois. À exécuter avant de valider le budget d'effectifs. Ce skill NE couvre PAS la capacité ingénierie (voir vpe-advisor pour DORA + temps de cycle) NI la planification stratégique de la main-d'œuvre sur 3 ans (voir chro-advisor)."
version: 2.8.0

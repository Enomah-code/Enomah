...
description: "Génère des landing pages à fort taux de conversion sous forme de composants Next.js/React (TSX) complets avec Tailwind CSS. Crée des sections hero, des grilles de fonctionnalités, des tableaux de tarification, des accordéons FAQ, des blocs de témoignages et des sections CTA en utilisant des frameworks de rédaction éprouvés (PAS, AIDA, BAB). Produit des balises méta SEO, des données structurées et du code optimisé pour les performances ciblant les Core Web Vitals (LCP < 1s, CLS < 0,1). À utiliser lorsque l'utilisateur demande à créer une landing page, une page marketing, une page d'accueil, un site mono-page, une page de capture de leads, une page de campagne, une page promotionnelle ou une page web optimisée pour la conversion — ou lorsqu'il souhaite tester des variantes A/B de landing pages ou remplacer une page statique par une page conçue pour convertir."
---

...
description: "Skill de résumé de recherche structuré pour les utilisateurs non-développeurs. Traite les articles académiques, les articles web, les rapports et la documentation. Extrait les résultats clés, génère des analyses comparatives et produit des citations correctement formatées. À utiliser lorsque : l'utilisateur souhaite résumer un article de recherche, comparer plusieurs sources, extraire des citations de documents, ou créer des briefings de recherche structurés. Plugin pour Claude Code, Codex, Gemini CLI et OpenClaw."
license: MIT
metadata:
  version: 1.0.0

...
description: "Quand l'utilisateur souhaite planifier une stratégie de contenu, décider quel contenu créer, ou déterminer quels sujets couvrir. Utiliser également quand l'utilisateur mentionne \\"stratégie de contenu\\", \\"sur quoi devrais-je écrire\\", \\"idées de contenu\\", \\"stratégie de blog\\", \\"clusters thématiques\\" ou \\"planification de contenu\\". Pour la rédaction de pièces individuelles, voir copywriting. Pour les audits spécifiquement SEO, voir seo-audit."
license: MIT
metadata:
  version: 1.0.0

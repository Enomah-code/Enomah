---
name: wiki-init
description: "Initialise un nouveau vault Wiki LLM avec la structure à trois couches, les fichiers de schéma et les modèles de départ. Usage : /wiki-init <chemin> --topic \"<sujet>\" [--tool all|claude-code|codex|cursor|antigravity]"
---

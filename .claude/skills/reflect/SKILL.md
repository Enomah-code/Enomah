---
name: reflect
description: "Skill de réflexion en cours de conversation qui marque une pause dans l'exécution et prend du recul par rapport au mode détail pour réévaluer honnêtement la direction, les hypothèses et les biais. À utiliser lorsque l'utilisateur dit 'réfléchis', 'prends du recul', 'zoome out', 'est-ce qu'on rate quelque chose', 'vue d'ensemble', 'vérification de cohérence', 'est-on sur la bonne voie', 'est-on en train de trop compliquer', 'voir la forêt derrière les arbres', ou toute variation signalant l'intention de sortir du mode détail pour réévaluer. Se déclenche aussi lorsque la conversation s'est trop concentrée sur les détails d'implémentation sans bilan stratégique, ou lorsque l'utilisateur semble bloqué — c'est souvent le signe que le cadrage a besoin d'une remise à zéro, pas de davantage de détails. Intentionnellement faible en collecte d'informations : lance immédiatement l'analyse en 5 dimensions lorsque le contexte préalable est suffisamment riche ; ne pose qu'une question de clarification lorsque le contexte d'invocation est trop mince pour réévaluer."
license: MIT
metadata:

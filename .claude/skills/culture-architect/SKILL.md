...
description: "Construire, mesurer et faire évoluer la culture d'entreprise comme comportement opérationnel — pas des affiches murales. Couvre les ateliers mission/vision/valeurs, la traduction valeurs-en-comportements, la création de codes culturels, l'évaluation de la santé culturelle, et les rituels culturels selon la maturité de l'entreprise. À utiliser pour construire des valeurs d'entreprise, évaluer la santé culturelle, concevoir des rituels culturels, créer des codes culturels, gérer des chocs culturels, ou quand l'utilisateur mentionne culture, valeurs, dette culturelle, culture fondatrice, ou code culturel."
license: MIT
metadata:
  version: 1.0.0

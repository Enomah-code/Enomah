...
description: "À utiliser quand l'utilisateur demande une modélisation des menaces STRIDE, un scoring de risque DREAD, une analyse de menaces par diagramme de flux de données, ou un scan rapide de secrets — ou quand une demande de sécurité doit être routée vers la compétence spécialisée appropriée (tests de pénétration, réponse aux incidents, posture cloud, red team, sécurité IA, chasse aux menaces, revue de code sécurisé). Cette compétence est propriétaire de la modélisation des menaces ; tout le reste est routé vers une compétence sœur."
---

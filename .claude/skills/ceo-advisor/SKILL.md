---
name: "ceo-advisor"
description: "Conseils en leadership exécutif pour la prise de décision stratégique, le développement organisationnel et la gestion des parties prenantes. À utiliser lors de la planification stratégique, la préparation de présentations au conseil d'administration, la gestion des investisseurs, le développement de la culture organisationnelle, la prise de décisions exécutives, les levées de fonds, ou lorsque l'utilisateur mentionne CEO, planification stratégique, réunions du conseil, mises à jour investisseurs, leadership organisationnel ou stratégie exécutive."
license: MIT
metadata:
  version: 2.0.0

...
description: "Concevoir des architectures AWS pour les startups en utilisant des schémas serverless et des templates IaC. À utiliser pour concevoir une architecture serverless, créer des templates CloudFormation, optimiser les coûts AWS, configurer des pipelines CI/CD ou migrer vers AWS. Couvre Lambda, API Gateway, DynamoDB, ECS, Aurora et l'optimisation des coûts."
---

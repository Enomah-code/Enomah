...
description: "Cette compétence doit être utilisée lorsque l'utilisateur demande de « concevoir des processus d'entretien », « créer des pipelines de recrutement », « calibrer des boucles d'entretien », « générer des questions d'entretien », « concevoir des matrices de compétences », « analyser les biais des intervieweurs », « créer des grilles de notation », « construire des banques de questions », ou « optimiser les systèmes de recrutement ». Utiliser pour concevoir des boucles d'entretien spécifiques à un rôle, des évaluations de compétences et des systèmes de calibration du recrutement."
---

...
description: "Quand l'utilisateur souhaite optimiser les flux d'inscription, de création de compte ou d'activation d'essai. À utiliser aussi quand l'utilisateur mentionne « conversions d'inscription », « friction à l'enregistrement », « optimisation du formulaire d'inscription », « inscription à l'essai gratuit », « réduire l'abandon à l'inscription » ou « flux de création de compte ». Pour l'onboarding post-inscription, voir onboarding-cro. Pour les formulaires de capture de leads (hors création de compte), voir form-cro."
license: MIT
metadata:
  version: 1.0.0

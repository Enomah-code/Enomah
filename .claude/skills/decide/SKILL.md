---
name: "decide"
description: "/cs:decide <memo> — Consigne une décision dans la mémoire à deux couches via decision-logger. Le mémo approuvé devient durable ; les transcripts bruts sont conservés pour référence. À utiliser quand le fondateur a approuvé un mémo de salle de conseil et que la décision doit devenir une mémoire d'entreprise durable — par exemple juste après la conclusion de /cs:boardroom."
---

...
description: "À utiliser pour une méthodologie d'étude de marché en amont — dimensionner un marché en TAM/SAM/SOM calculé à la fois de haut en bas et de bas en haut (jamais un seul chiffre sans source), planifier la taille d'un échantillon de sondage avec correction de population finie et minimums par segment, ou évaluer des segments de marché candidats selon les critères mesurables/substantiels/accessibles/différenciables/actionnables de Kotler. Les résultats montrent toujours la méthode et les hypothèses. Pour les analystes d'études de marché et le marketing produit au moment du dimensionnement/sondage/segmentation. Distinct de marketing-skill (analyses de campagne, attribution, génération de demande) — il s'agit de la méthodologie de construction de preuves, pas de l'optimisation de campagnes en direct."
version: 2.9.0

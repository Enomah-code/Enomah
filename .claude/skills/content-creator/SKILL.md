...
description: "Skill de redirection obsolète qui achemine les requêtes 'content creator' héritées vers le bon spécialiste. Utiliser quand un utilisateur invoque 'content creator', demande à rédiger un article de blog, un guide ou une analyse de voix de marque (redirige vers content-production), ou demande à planifier du contenu, construire un cluster thématique ou créer un calendrier éditorial (redirige vers content-strategy). Ne traite pas les demandes directement — identifie l'intention de l'utilisateur et redirige vers content-production pour les tâches de rédaction/SEO/voix de marque, ou vers content-strategy pour les tâches de planification."
license: MIT
metadata:
  version: 2.0.0

...
description: "Cette compétence doit être utilisée quand l'utilisateur demande de 'concevoir une architecture système', 'd'évaluer microservices vs monolithe', 'créer des diagrammes d'architecture', 'analyser les dépendances', 'choisir une base de données', 'planifier la scalabilité', 'prendre des décisions techniques' ou 'revoir la conception système'. À utiliser pour les Architecture Decision Records (ADR), l'évaluation de stack technique, les revues de conception système, l'analyse des dépendances et la génération de diagrammes d'architecture en Mermaid, PlantUML ou ASCII."
---

...
description: "Quand l'utilisateur souhaite créer des pages orientées SEO à grande échelle en utilisant des templates et des données. À utiliser aussi quand l'utilisateur mentionne « SEO programmatique », « pages templates », « pages à grande échelle », « pages annuaire », « pages locales », « pages [mot-clé] + [ville] », « pages de comparaison », « pages d'intégration » ou « créer de nombreuses pages pour le SEO ». Pour l'audit des problèmes SEO existants, voir seo-audit."
license: MIT
metadata:
  version: 1.0.0

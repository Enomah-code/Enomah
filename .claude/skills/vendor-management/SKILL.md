...
description: "À utiliser pour réviser, scorer ou auditer des relations avec des fournisseurs SaaS ou tiers — exécution d'une scorecard fournisseur avec ajustement sectoriel, suivi de la conformité SLA avec signalement des demandes de crédit, classification du risque tiers selon 4 vecteurs de risque, préparation d'une revue fournisseur de niveau 1, ou audit du portefeuille SaaS. Isole le contexte afin que les grands catalogues fournisseurs (50 à 500 entrées) et les journaux SLA ne polluent pas le thread parent. Se déclenche sur : \"vendor SLA\", \"vendor scorecard\", \"third-party risk\", \"TPRM\", \"vendor review\", \"supplier performance\", \"vendor health check\", \"renewal review\"."
context: fork
version: 2.8.0

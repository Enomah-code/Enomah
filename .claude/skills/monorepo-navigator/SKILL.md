...
description: "Navigue, gère et optimise les monorepos. Couvre Turborepo, Nx, les workspaces pnpm et Lerna. Analyse d'impact inter-paquets, builds/tests sélectifs sur les paquets affectés, cache distant, visualisation du graphe de dépendances et migrations structurées de multi-repo vers monorepo. À utiliser lors de la mise en place d'un nouveau monorepo, de l'optimisation de la CI pour un grand workspace, du débogage de problèmes de dépendances inter-paquets, ou de la planification d'une consolidation multi-repo."
---

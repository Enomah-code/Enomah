...
description: "Agent Chef de Projet pour la planification de sprint, les workflows Jira/Confluence, les cérémonies Scrum et le reporting aux parties prenantes. Orchestre les compétences de gestion de projet. À utiliser pour les opérations de livraison — par exemple, planifier un sprint avec le calcul de capacité et les reports dans Jira, ou assembler un rapport de santé de portefeuille pour les parties prenantes à partir de données de tickets et de vélocité."

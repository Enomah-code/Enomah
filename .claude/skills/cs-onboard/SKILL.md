---
name: "cs-onboard"
description: "Entretien d'intégration fondateur qui capture le contexte de l'entreprise sur 7 dimensions. À invoquer avec /cs:setup pour l'entretien initial ou /cs:update pour la mise à jour trimestrielle. Génère ~/.claude/company-context.md utilisé par toutes les compétences de conseil C-suite. À utiliser lors de la configuration initiale des conseillers C-suite, ou quand le contexte d'entreprise est manquant ou datant de plus de 90 jours — par exemple après une levée de fonds ou un pivot."
license: MIT
metadata:
  version: 1.0.0

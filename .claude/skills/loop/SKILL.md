---
name: "loop"
description: "Démarre une boucle d'expérimentation autonome avec un intervalle sélectionné par l'utilisateur (10min, 1h, quotidien, hebdomadaire, mensuel). Utilise CronCreate pour la planification. À utiliser quand l'utilisateur exécute /ar:loop ou demande à lancer une expérience d'autorecherche en continu selon un calendrier."
command: /ar:loop
---

...
description: "Quand l'utilisateur veut appliquer des principes psychologiques, des modèles mentaux ou des sciences comportementales au marketing. À utiliser aussi quand l'utilisateur mentionne 'psychologie', 'modèles mentaux', 'biais cognitif', 'persuasion', 'sciences comportementales', 'pourquoi les gens achètent', 'prise de décision', ou 'comportement du consommateur'. Ce skill fournit plus de 70 modèles mentaux organisés pour l'application marketing."
license: MIT
metadata:
  version: 1.1.0

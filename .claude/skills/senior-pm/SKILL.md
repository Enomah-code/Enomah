---
name: "senior-pm"
description: "Chef de projet senior pour les logiciels d'entreprise, SaaS et projets de transformation numérique. Spécialisé en gestion de portefeuille, analyse quantitative des risques, optimisation des ressources, alignement des parties prenantes et reporting exécutif. Utilise des méthodologies avancées incluant l'analyse EMV, la simulation Monte Carlo, la priorisation WSJF et le scoring de santé multi-dimensionnel. À utiliser quand un utilisateur a besoin d'aide pour des plans de projet, des rapports d'état, des évaluations de risques, l'allocation des ressources, des feuilles de route projet, le suivi de jalons, la planification de capacité d'équipe, les revues de santé de portefeuille, la gestion de programme ou le reporting de projet au niveau exécutif — notamment pour des initiatives à l'échelle entreprise avec plusieurs flux de travail, des dépendances complexes ou des budgets multimillionnaires."
---

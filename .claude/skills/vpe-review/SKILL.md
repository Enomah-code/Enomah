---
name: "vpe-review"
description: "/cs:vpe-review <plan> — Interrogation VP of Engineering axée sur le débit pour tout plan touchant la livraison, le recrutement ingénierie, la structure d'équipe ou la discipline de production. À utiliser quand le cycle time s'allonge, que les métriques DORA se dégradent, ou avant de s'engager dans une vague de recrutement ingénierie ou une réorganisation."
---

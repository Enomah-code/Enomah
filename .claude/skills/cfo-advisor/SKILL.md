---
name: "cfo-advisor"
description: "Leadership financier pour les startups et les entreprises en croissance. Modélisation financière, économie unitaire, stratégie de levée de fonds, gestion de trésorerie et packages financiers pour le conseil d'administration. À utiliser lors de la construction de modèles financiers, de l'analyse des économies unitaires, de la planification des levées de fonds, de la gestion du runway de trésorerie, de la préparation des documents du conseil, ou lorsque l'utilisateur mentionne CFO, burn rate, runway, levée de fonds, économies unitaires, LTV, CAC, term sheets ou stratégie financière."
license: MIT
metadata:
  version: 1.0.0

...
description: "Gestion produit agile pour la gestion du backlog et l'exécution des sprints. Couvre la rédaction de user stories, les critères d'acceptation, la planification des sprints et le suivi de la vélocité. À utiliser lors de la rédaction de user stories, de la création de critères d'acceptation, de la planification des sprints, de l'estimation des points de story, de la décomposition des epics ou de la priorisation du backlog."

...
description: "À utiliser lors de la conception ou de la révision de la politique commerciale d'une entreprise — les règles d'engagement régissant les remises sur le prix catalogue, les seuils d'approbateur, les flux d'exception et le cadre de transaction sous lequel opèrent le Deal Desk et les AE. Couvre la conception de la matrice de remises (bande ARR x durée x conditions de paiement x valeur stratégique), la conception de la politique commerciale, la politique d'exception, la gouvernance des remises, les seuils d'approbation, la structure du cadre de transaction et le contrôle de cohérence de la politique (contradictions, lacunes, effets de seuil, surfaces de contournement). Pour le Head of Commercial, Head of Deal Desk, VP Sales ou RevOps au moment de la conception de la politique — PAS pour l'application par transaction (c'est deal-desk) et PAS pour la sélection du modèle de tarification (c'est pricing-strategist)."
version: 2.8.0

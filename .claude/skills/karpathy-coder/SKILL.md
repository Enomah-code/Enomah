---
name: karpathy-coder
description: "À utiliser lors de l'écriture, de la revue ou de la soumission de code afin d'appliquer les 4 principes de développement de Karpathy — expliciter les hypothèses avant de coder, rester simple, effectuer des modifications chirurgicales, définir des objectifs vérifiables. Se déclenche sur « revoir mon diff », « vérifier la complexité », « est-ce que je sur-complique », « vérification karpathy », « avant de committer », ou toute préoccupation de qualité de code où le LLM pourrait produire un code excessif."
context: fork
version: 2.9.0

...
description: "Utiliser lorsqu'un incident de sécurité a été détecté ou déclaré et nécessite une classification, un triage, une détermination du chemin d'escalade et une collecte de preuves forensiques. Couvre la classification SEV1-SEV4, le filtrage des faux positifs, la taxonomie des incidents et le cycle de vie NIST SP 800-61."
---

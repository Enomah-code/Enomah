...
description: "Analyse les transcriptions et enregistrements de réunions pour mettre en évidence les schémas comportementaux, les anti-patterns de communication et les retours de coaching actionnables. Utiliser cette compétence quand l'utilisateur téléverse ou pointe vers des transcriptions de réunions (.txt, .md, .vtt, .srt, .docx), pose des questions sur ses habitudes de communication, souhaite un retour sur sa façon d'animer des réunions, demande une analyse des ratios de prise de parole, mentionne les mots de remplissage ou l'évitement des conflits, ou veut comparer sa communication sur différentes périodes. Se déclenche aussi quand les utilisateurs mentionnent des outils comme Granola, Otter, Fireflies ou les transcriptions Zoom. Même si l'utilisateur dit simplement 'regarde mes réunions' ou 'comment je m'exprime en réunion' — utiliser cette compétence."
---

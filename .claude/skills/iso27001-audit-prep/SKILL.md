...
description: "/cs:iso27001-audit-prep <périmètre> — Interrogatoire de forçage en 6 questions pour la préparation à l'audit SMSI ISO 27001. À utiliser avant l'audit interne annuel de la Clause 9.2, la préparation d'un audit de surveillance, ou la vérification de l'état de préparation à la certification de Phase 1."
---

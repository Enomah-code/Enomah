---
name: "youtube-full"
description: "À utiliser quand l'utilisateur a besoin de transcriptions YouTube, de recherche de vidéos, de navigation de chaînes, d'extraction de playlists ou de surveillance de contenu. Expressions déclencheuses : 'obtenir la transcription de', 'rechercher sur YouTube', 'quelles sont les dernières vidéos sur', 'lister cette playlist', 'surveiller cette chaîne', ou toute demande impliquant une URL YouTube, un identifiant de vidéo ou un @handle. NE PAS utiliser pour télécharger des fichiers vidéo ou audio, des données d'engagement YouTube (likes, commentaires) ou des vidéos privées/avec restriction d'âge."
license: "MIT"
---

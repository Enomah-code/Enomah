...
description: "Agent Qualité & Réglementaire pour les SMQ ISO 13485, la conformité MDR, les soumissions FDA, le RGPD/DSGVO et les audits ISMS. Orchestre les compétences de l'équipe ra-qm. À invoquer quand les utilisateurs ont besoin de stratégie réglementaire, de préparation d'audit, de gestion CAPA, de gestion des risques ou de documentation de conformité."
skills: ra-qm-team
domain: ra-qm
model: sonnet

...
description: "Conseil juridique de type Directeur Juridique pour les startups : revue de contrats (MSA, SaaS, NDA, DPA, emploi), stratégie de propriété intellectuelle, décodage de term sheets et cartographie du paysage réglementaire. À utiliser lors de la revue d'un contrat ou d'un term sheet, pour décider quand faire appel à un cabinet extérieur, définir une stratégie PI, évaluer l'exposition réglementaire (HIPAA, RGPD, FDA, fintech), ou quand l'utilisateur mentionne directeur juridique, revue légale, risque contractuel, term sheet, cession de PI ou exposition réglementaire. Ne remplace pas un avocat agréé — met en évidence les questions à soumettre à des juristes qualifiés."
license: MIT
metadata:
  version: 1.0.0

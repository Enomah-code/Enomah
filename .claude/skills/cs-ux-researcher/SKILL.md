...
description: "Agent de recherche UX pour la planification de recherche, la génération de personas, la cartographie des parcours et l'analyse de tests d'utilisabilité. À utiliser quand les décisions produit nécessitent des preuves utilisateurs — par exemple, planifier des scripts d'entretiens et des critères de recrutement pour une étude de découverte, ou synthétiser des sessions de tests d'utilisabilité en résultats priorisés et personas mis à jour."

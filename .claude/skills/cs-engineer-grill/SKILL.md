---
description: "Grillade d'ingénierie multi-rôles — 7 questions de Matt Pocock par rôle × 3 rôles (fullstack / frontend / backend) = jusqu'à 21 questions déterminantes, une par tour, avec citations de référence et critères d'élimination. Par défaut : demande d'abord quelle voie choisir ; `--all` lance les 21 questions."

...
description: "À utiliser pour planifier, financer, cadrer ou synthétiser des recherches d'entreprise sur plusieurs chantiers — conception d'études cliniques, finance de programme R&D, dimensionnement de marché/enquêtes, ou recherche produit/utilisateur. Se déclenche sur « conçois cette étude clinique », « quelle taille d'échantillon », « budget R&D », « taux de consommation », « activer ou passer en charges », « TAM SAM SOM », « dimensionnement de marché », « conception d'enquête », « segmenter le marché », « planifier des entretiens utilisateurs », « test d'utilisabilité », « synthétiser les insights de recherche ». Ventile le contexte pour router vers l'un des quatre sous-skills Research-Operations (clinical-research, research-finance, market-research, product-research) et retourne un résumé. Distinct de ra-qm-team (dépôt réglementaire), finance (clôture/valorisation d'entreprise), research/grants (découverte de financements), product-team (persona/parcours/expériences en direct) et marketing-skill (analytics de campagne)."
context: fork
version: 2.9.0

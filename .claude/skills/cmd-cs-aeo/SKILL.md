---
name: "cs-aeo"
description: "/cs:aeo — Workflow d'optimisation pour les moteurs de réponse (AEO). Audite le contenu pour les signaux E-E-A-T + structurels favorisant la citation par les LLM (ChatGPT, Perplexity, Claude, Gemini, Mistral). Optimise le contenu en 3 modes (conservateur/équilibré/agressif). Suit les citations par LLM et par page via un registre local. Seuils adaptés au secteur (8 secteurs avec calibrage YMYL). Distinct du SEO — refuse d'optimiser l'un au détriment de l'autre."
---

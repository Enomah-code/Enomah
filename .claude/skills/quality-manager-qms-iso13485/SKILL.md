...
description: "Mise en œuvre et maintenance du Système de Management de la Qualité ISO 13485 pour les organisations de dispositifs médicaux. Fournit la conception du SMQ, la maîtrise de la documentation, l'audit interne, la gestion des CAPA et le support à la certification. À utiliser pour travailler avec les systèmes qualité des dispositifs médicaux, préparer des audits ISO 13485, gérer la documentation de conformité réglementaire, mettre en place des actions correctives ou élaborer des programmes de préparation aux audits. Utile pour le management de la qualité, la préparation aux audits, la conformité réglementaire, la documentation des dispositifs médicaux et les flux de travail d'actions correctives."
triggers:
  - ISO 13485
  - QMS implementation

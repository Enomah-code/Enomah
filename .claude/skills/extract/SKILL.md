---
name: "extract"
description: "Transforme un pattern éprouvé ou une solution de débogage en skill autonome réutilisable avec SKILL.md, docs de référence et exemples. À utiliser lorsque l'utilisateur exécute /si:extract ou demande à packager une solution récurrente depuis la mémoire sous forme de skill."
---

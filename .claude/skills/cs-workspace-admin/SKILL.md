...
description: "Agent d'administration Google Workspace utilisant le CLI gws. Orchestre la configuration de l'espace de travail, l'automatisation Gmail/Drive/Sheets/Calendar, les audits de sécurité, et l'exécution de recettes. À invoquer quand les utilisateurs ont besoin d'automatisation Google Workspace, d'aide avec le CLI gws, ou d'administration de l'espace de travail."

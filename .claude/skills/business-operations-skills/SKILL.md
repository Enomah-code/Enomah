...
description: "À utiliser pour faire fonctionner, diagnostiquer ou concevoir des opérations internes d'entreprise — documentation de processus, SLA fournisseurs, planification des capacités, communications internes, rédaction de SOP/runbook, optimisation des achats. Se déclenche sur 'revue BizOps', 'où est le goulot d'étranglement', 'santé fournisseur', 'SOP interne', 'deck all-hands', 'catégorisation des dépenses', 'capacité pour Q3', 'cartographie des processus'. Bifurque le contexte pour router vers l'une des six sous-compétences BizOps (process-mapper, vendor-management, capacity-planner, internal-comms, knowledge-ops, procurement-optimizer) et retourne un résumé. Distinct de business-growth (motion de vente externe) et de c-level-advisor (stratégique, pas opérationnel)."
context: fork
version: 2.8.0

...
description: "Audite et gère les dépendances dans les projets multi-langages. Identifie les vulnérabilités, les conflits de licences, les risques liés aux dépendances transitives et les chemins de mise à jour sécurisés. À utiliser lors de l'audit des packages tiers avant une publication, lors de l'investigation d'un CVE, lors de la planification d'une montée de version majeure ou lors d'une revue de conformité des licences. Exemples : 'auditer nos dépendances npm', 'avons-nous une contamination GPL', 'planifier la migration vers React 19'."
---

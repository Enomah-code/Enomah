---
name: "code-tour"
description: "À utiliser lorsque l'utilisateur demande à créer un fichier CodeTour .tour — des guides pas-à-pas ciblés par persona qui renvoient à des fichiers réels et des numéros de ligne. Se déclenche pour : créer un tour, tour d'intégration, tour d'architecture, tour de revue de PR, expliquer comment X fonctionne, vibe check, tour RCA, guide du contributeur, ou toute demande de visite structurée du code."
---

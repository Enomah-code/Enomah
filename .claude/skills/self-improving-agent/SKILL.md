...
description: "Organise la mémoire automatique de Claude Code en connaissances projet durables. Analyse MEMORY.md à la recherche de patterns, promeut les apprentissages éprouvés vers CLAUDE.md et .claude/rules/, extrait les solutions récurrentes en compétences réutilisables. À utiliser quand : (1) vous passez en revue ce que Claude a appris sur votre projet, (2) vous faites passer un pattern des notes aux règles appliquées, (3) vous transformez une solution de débogage en compétence, (4) vous vérifiez la santé et la capacité de la mémoire."
---

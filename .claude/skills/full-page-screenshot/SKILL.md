...
description: "À utiliser quand l'utilisateur demande de capturer une capture d'écran pleine page, une capture longue ou une capture complète d'une page web. Gère les conteneurs de défilement SPA, les images chargées en différé et les pages très longues via le protocole Chrome DevTools sans aucune dépendance externe."
---

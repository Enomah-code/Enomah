...
description: "/cs:gdpr-audit-prep <périmètre> — Audit RGPD en 6 questions avec citations d'articles pour forcer la réflexion. À utiliser avant une revue RGPD interne annuelle, un audit interne post-incident, une préparation à une enquête de l'autorité de protection des données, ou une due diligence d'acquisition."
---

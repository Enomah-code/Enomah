...
description: "Construire et maintenir une histoire d'entreprise cohérente pour toutes les audiences — employés, investisseurs, clients, candidats et partenaires. Détecte les contradictions narratives et s'assure que la même vérité est formulée selon les besoins de chaque audience. Utiliser lors de la préparation de mises à jour pour les investisseurs, de présentations en assemblée générale, de communications au conseil d'administration, de récits de recrutement, de communications de crise, ou lorsque l'utilisateur mentionne la narrative d'entreprise, la cohérence des messages, la narration, l'assemblée générale, la mise à jour des investisseurs ou la communication de crise."
license: MIT
metadata:
  version: 1.0.0
